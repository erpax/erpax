...
describe('encryption', () => {
  const testKey = 'ZGVmYXVsdC10ZXN0LWtleS1mb3ItdGVzdGluZy1vbmx5LWRvLW5vdC11c2UtaW4tPXJvZA=='
  ...
  describe('encryptField & decryptField', () => {
    ...
    it('should throw when ENCRYPTION_KEY not set', () => {
      delete process.env.ENCRYPTION_KEY

      expect(() => encryptField('test')).toThrow('ENCRYPTION_KEY')
      expect(() => decryptField('test:data:here')).toThrow('ENCRYPTION_KEY')
    })
