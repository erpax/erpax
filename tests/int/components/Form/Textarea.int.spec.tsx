...
describe('Textarea Form Field', () => {
  ...
  describe('rendering', () => {
    it('renders textarea input', () => {
      renderForm((register, errors) => (
        <Textarea {...defaultProps} register={register} errors={errors} />
      ))
    ...
    it('renders label', () => {
      renderForm((register, errors) => (
        <Textarea {...defaultProps} label="Comments" register={register} errors={errors} />
      ))
  ...
  describe('rows property', () => {
    ...
    it('uses custom rows value', () => {
      const { container } = renderForm((register, errors) => (
        <Textarea {...defaultProps} rows={5} register={register} errors={errors} />
      ))
      const textarea = container.querySelector('textarea')
    ...
    it('handles large row values', () => {
      const { container } = renderForm((register, errors) => (
        <Textarea {...defaultProps} rows={20} register={register} errors={errors} />
      ))
      const textarea = container.querySelector('textarea')
  ...
  describe('required field', () => {
    it('shows required indicator when required is true', () => {
      renderForm((register, errors) => (
        <Textarea {...defaultProps} required register={register} errors={errors} />
      ))
    ...
    it('passes required to register', () => {
      ...
      render(<Textarea {...defaultProps} required register={register as any} errors={{}} />)
      expect(register).toHaveBeenCalledWith('textareaField', { required: true })
    })
  })
  ...
  describe('width property', () => {
    it('passes width to FormField', () => {
      const { container } = renderForm((register, errors) => (
        <Textarea {...defaultProps} width="full" register={register} errors={errors} />
      ))
  ...
  describe('field name', () => {
    it('uses field name from props', () => {
      const { container } = renderForm((register, errors) => (
        <Textarea {...defaultProps} name="userFeedback" register={register} errors={errors} />
      ))
      const textarea = container.querySelector('textarea')
  ...
  describe('error handling', () => {
    it('displays error when field has validation error', () => {
      ...
      render(
        <FormHarness>
          {(register) => (
            <Textarea {...defaultProps} register={register} errors={mockErrors as any} />
          )}
        </FormHarness>,
      )
