...
> atom `keyword` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `keyword`
- partition root `66d9e455-27a7-85c7-89f1-fd2431402978`
- bond degree `17`
...
<sub>content-uuid `657ac37c-08a4-802c-9cc9-6a96856a797c` · framed by typography partition `keyword` bonds `17` · `pnpm readme` · `pnpm readme:check`</sub>
