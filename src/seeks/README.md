...
> atom `seeks` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `seeks`
- partition root `4ca0e980-46f4-87f5-8880-9dfe4a5f2e11`
- bond degree `6`
...
<sub>content-uuid `42bd880d-6589-8a6d-aaa6-9702ea7a55c9` · framed by typography partition `seeks` bonds `6` · `pnpm readme` · `pnpm readme:check`</sub>
