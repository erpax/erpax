...
/** Credit for claims in src/site/tenant/where/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/site/tenant/where/index.ts — leftover wave proof', () => {
