...
> atom `penalty` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `penalty`
- partition root `37649311-1996-8fb1-ba13-5ef30e3e2661`
- bond degree `12`
...
<sub>content-uuid `d8c928cb-3838-8a8a-a670-6980d8668598` · framed by typography partition `penalty` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
