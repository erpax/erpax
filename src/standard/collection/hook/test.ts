...
/** Credit for claims in src/standard/collection/hook/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/standard/collection/hook/index.ts — leftover wave proof', () => {
