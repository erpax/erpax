...
> atom `specialty` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `specialty`
- partition root `4c7cc16a-27c5-8908-b130-1f5a6d9ee2dd`
- bond degree `25`
...
<sub>content-uuid `56e0e446-6d6b-8c9b-840f-9364a0ba5deb` · framed by typography partition `specialty` bonds `25` · `pnpm readme` · `pnpm readme:check`</sub>
