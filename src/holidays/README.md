...
> atom `holidays` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `holidays`
- partition root `2e2aa4fd-3b69-89eb-91e6-7076d26b78f7`
- bond degree `12`
...
<sub>content-uuid `658ad279-c636-8555-8492-fbb7f1de7826` · framed by typography partition `holidays` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
