...
> atom `performed` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `performed`
- partition root `def8fcaf-ddf5-853e-9e72-3c6217b04229`
- bond degree `16`
...
<sub>content-uuid `0c22d8ce-2a76-8629-9ede-4125842ec9cd` · framed by typography partition `performed` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
