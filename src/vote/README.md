...
> atom `vote` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `vote`
- partition root `155f9768-0776-86ae-8dc3-98888bd12cf0`
- bond degree `9`
...
<sub>content-uuid `a93c4b53-97c5-8f0d-87ef-a320c2d91da7` · framed by typography partition `vote` bonds `9` · `pnpm readme` · `pnpm readme:check`</sub>
