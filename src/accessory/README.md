...
> atom `accessory` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `accessory`
- partition root `7ba17c43-b089-8781-a2dc-704577746958`
- bond degree `19`
...
<sub>content-uuid `e94fd9f9-3dc1-82fa-b561-22fdf43f81b5` · framed by typography partition `accessory` bonds `19` · `pnpm readme` · `pnpm readme:check`</sub>
