...
> atom `hosp` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `hosp`
- partition root `f8feff88-0281-863e-9683-91dffd9b0018`
- bond degree `28`
...
<sub>content-uuid `967cfaa9-6642-889a-bfbc-3eef5e504ed5` · framed by typography partition `hosp` bonds `28` · `pnpm readme` · `pnpm readme:check`</sub>
