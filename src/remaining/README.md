...
> atom `remaining` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `remaining`
- partition root `add4777b-8199-8bd8-bf29-ca40b03d74e4`
- bond degree `19`
...
<sub>content-uuid `e5ed0c8b-f9be-82dd-bc87-54ebd39e2ff9` · framed by typography partition `remaining` bonds `19` · `pnpm readme` · `pnpm readme:check`</sub>
