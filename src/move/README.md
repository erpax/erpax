...
> atom `move` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `move`
- partition root `4df81a1d-9b92-8043-baf9-4aedb93fa74e`
- bond degree `13`
...
<sub>content-uuid `14975602-dc4f-8cd9-8304-c0f672e24bce` · framed by typography partition `move` bonds `13` · `pnpm readme` · `pnpm readme:check`</sub>
