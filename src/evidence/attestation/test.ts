...
/** Credit for claims in src/evidence/attestation/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/evidence/attestation/index.ts — leftover wave proof', () => {
