...
> atom `proprietary` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition root `6054881f-1ffa-80f4-82d0-7862cc999098`
- bond degree `24`
...
<sub>content-uuid `7785a5f6-0ec6-8f2b-89ca-00a1d76cab8e` · framed by typography partition `proprietary` bonds `24` · `pnpm readme` · `pnpm readme:check`</sub>
