...
> atom `closes` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `closes`
- partition root `baa6d40a-32a7-8e97-bddc-1de5e27b43f2`
- bond degree `14`
...
<sub>content-uuid `ba019edf-873e-87ae-ab69-8fe0f586c424` · framed by typography partition `closes` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
