...
> atom `blinded` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `blinded`
- partition root `d11817c7-144a-8413-b941-b379dc066d1a`
- bond degree `16`
...
<sub>content-uuid `2fa1d078-ac0d-84fc-896c-46aeb6ae6ec0` · framed by typography partition `blinded` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
