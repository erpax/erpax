...
describe('blocks/form/number', () => {
  ...
  it('WCAG 1.3.1 · 4.1.2 — the control is reachable BY ITS LABEL', () => {
    render(<Number {...({} as React.ComponentProps<typeof Number>)} name="who" label="Your name" errors={{}} register={register} />)
  ...
  it('marks a required field in the accessible name, not only in colour', () => {
    render(<Number {...({} as React.ComponentProps<typeof Number>)} name="who" label="Your name" required errors={{}} register={register} />)
