...
// possible state of diamond/seal and forbade nothing. What seal actually owes its
// callers is its FACE: import { X } from '@/diamond/seal' breaks the moment the barrel
