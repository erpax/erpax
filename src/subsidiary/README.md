...
> atom `subsidiary` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition root `95ae6ff2-662b-8c3b-a965-571d7da10828`
- bond degree `14`
...
<sub>content-uuid `cb186032-8d82-8305-990f-efdf0ac71591` · framed by typography partition `subsidiary` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
