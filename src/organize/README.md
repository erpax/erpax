...
> atom `organize` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `organize`
- partition root `89969462-290a-8c18-a595-95d3b0e5ed02`
- bond degree `13`
...
<sub>content-uuid `b2a9be75-a7b6-8102-b966-3493ed8842b1` · framed by typography partition `organize` bonds `13` · `pnpm readme` · `pnpm readme:check`</sub>
