...
> atom `incentives` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition root `16bcbb05-3f9f-8963-bc42-6659c7e8ad02`
- bond degree `12`
...
<sub>content-uuid `704ec12c-c2f6-8942-af05-f6151f453ffb` · framed by typography partition `incentives` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
