...
Matter-twin: `src/services/uuid-format` (encode/decodeStructured, coverage = Law 62) + `src/services/integrity/content-uuid.ts`. The cited form must be true ([[standard]] RFC 9562). Composes: [[identity]] · [[collapse]] · [[torus]] · [[whole]] · [[one]] · [[merge]] · [[holographic]] · [[self]] · [[signal]] · [[standard]].
