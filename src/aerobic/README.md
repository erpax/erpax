...
> atom `aerobic` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `aerobic`
- partition root `b879bac1-e3b2-84b8-be13-fae83dd189ef`
- bond degree `12`
...
<sub>content-uuid `effa463f-82f6-8af0-b142-e04265bf7809` · framed by typography partition `aerobic` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
