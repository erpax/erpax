...
> atom `music` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `music`
- partition root `88870852-ae4f-81ca-8e57-2142ac0569fe`
- bond degree `50`
...
<sub>content-uuid `74beb86f-ec5f-87b4-9de1-13136149a02f` · framed by typography partition `music` bonds `50` · `pnpm readme` · `pnpm readme:check`</sub>
