...
> atom `subtitle` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `subtitle`
- partition root `4666120e-ee0e-8c54-bf2d-fa10075c8ed4`
- bond degree `16`
...
<sub>content-uuid `3f5e83d9-559e-8cd6-a737-c7f58fccbe24` · framed by typography partition `subtitle` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
