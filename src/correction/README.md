...
> atom `correction` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition root `c72d59fd-b542-81df-be17-bb1c322e7dc9`
- bond degree `12`
...
<sub>content-uuid `c8b7f91f-7d65-8ec2-8b03-58ed9b1efc68` · framed by typography partition `correction` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
