...
> atom `expression` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition root `3159e20c-698a-8376-b359-d66b3604093c`
- bond degree `14`
...
<sub>content-uuid `b14caa2b-f111-8023-ac5e-d451f3c1a633` · framed by typography partition `expression` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
