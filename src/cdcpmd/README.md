...
> atom `cdcpmd` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `cdcpmd`
- partition root `a9aae335-464f-800f-ad6d-812bf79b5ad2`
- bond degree `14`
...
<sub>content-uuid `1fe4ada6-b21c-879f-9dcb-83e48e3b3550` · framed by typography partition `cdcpmd` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
