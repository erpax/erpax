...
import { currencyField, statusField, notesField } from '@/base/accounting/field'
...
const BankTransactions: CollectionConfig = {
  ...
  hooks: standardCollectionHooks('bank-transactions', { beforeChange: [autoSetTimestamp('matchedAt', (d) => {
