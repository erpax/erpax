...
> atom `album` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `album`
- partition root `0f765228-39d7-80b2-a6b5-2f9a86b9fdb6`
- bond degree `18`
...
<sub>content-uuid `416abe41-e5be-8166-b3d2-327e46a16047` · framed by typography partition `album` bonds `18` · `pnpm readme` · `pnpm readme:check`</sub>
