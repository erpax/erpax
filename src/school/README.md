...
> atom `school` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `school`
- partition root `dae16bc0-6dab-87b3-8a93-49a5739ad076`
- bond degree `17`
...
<sub>content-uuid `a27acc03-1a55-8c49-8192-f8e2cf340891` · framed by typography partition `school` bonds `17` · `pnpm readme` · `pnpm readme:check`</sub>
