...
> atom `lab` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `lab`
- partition root `08cbebc2-4fa0-829a-8f37-c3e20cd25fe3`
- bond degree `12`
...
<sub>content-uuid `bef61ebe-6f29-88fb-83fe-69de2e1a3968` · framed by typography partition `lab` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
