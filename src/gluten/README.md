...
> atom `gluten` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `gluten`
- partition root `a47df7a9-eae2-8c3f-8474-2e66da643c48`
- bond degree `16`
...
<sub>content-uuid `15335bfb-4e41-8262-84ac-c6214b193e4c` · framed by typography partition `gluten` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
