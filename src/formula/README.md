...
> atom `formula` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `formula`
- partition root `958555c3-c607-84a3-aeb2-ec4e01555a77`
- bond degree `10`
...
<sub>content-uuid `aa7b0753-5260-8548-a3e6-4e4c2d55e9a0` · framed by typography partition `formula` bonds `10` · `pnpm readme` · `pnpm readme:check`</sub>
