...
> atom `painter` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `painter` · sub-root `c9071879-50a2-891a-920f-76b0062f00a7`
...
- partition `painter`
- partition root `c9071879-50a2-891a-920f-76b0062f00a7`
- bond degree `16`
...
<sub>content-uuid `86e1c84d-33eb-8843-8297-57fba6d45a88` · framed by typography partition `painter` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
