...
/** Credit for claims in src/tenant/remote/secret/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/tenant/remote/secret/index.ts — leftover wave proof', () => {
