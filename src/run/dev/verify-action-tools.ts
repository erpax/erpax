...
const { buildBatchTools } = await import('@/agents/mcp/tool/batch')
const { buildVersionsTools } = await import('@/agents/mcp/tool/versions')
const { checkMcpToolStandardization } = await import('@/agents/mcp/standardization')
