...
> atom `iupac` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `iupac`
- partition root `d4338da9-4cd2-8ac8-9873-ffebbb2fde52`
- bond degree `13`
...
<sub>content-uuid `b6dff206-c0e7-8302-8c46-ce03c368fec3` · framed by typography partition `iupac` bonds `13` · `pnpm readme` · `pnpm readme:check`</sub>
