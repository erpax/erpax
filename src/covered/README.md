...
> atom `covered` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `covered`
- partition root `ae9b0ce9-a988-8660-8f2f-20c1afae08a7`
- bond degree `18`
...
<sub>content-uuid `583ca1f6-5fbe-8eca-8a0c-5fe5fc435639` · framed by typography partition `covered` bonds `18` · `pnpm readme` · `pnpm readme:check`</sub>
