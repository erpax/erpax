...
> atom `occupational` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition root `f9afea3a-556d-8a51-80a9-22993f275347`
- bond degree `25`
...
<sub>content-uuid `ad3fcc64-bc43-88f6-b251-a39f8cdb6497` · framed by typography partition `occupational` bonds `25` · `pnpm readme` · `pnpm readme:check`</sub>
