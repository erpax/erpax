...
> atom `statistical` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `statistical`
- partition root `5419c111-a0bf-8cb0-80f4-17470c3d8bcb`
- bond degree `22`
...
<sub>content-uuid `9a3633dc-b9fd-8775-b2b0-3651b132a21c` · framed by typography partition `statistical` bonds `22` · `pnpm readme` · `pnpm readme:check`</sub>
