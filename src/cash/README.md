...
> atom `cash` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `cash`
- partition root `c6c9ee8c-0f7a-87f1-90ab-5cc65853bba8`
- bond degree `14`
...
<sub>content-uuid `5a314772-ddc2-80fd-8524-ca7c84df143f` · framed by typography partition `cash` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
