...
> atom `npi` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `npi`
- partition root `712974b2-252a-89fd-87c9-5692c4d24d54`
- bond degree `14`
...
<sub>content-uuid `8f3bc92f-eb79-880c-92f0-4bf13603b216` · framed by typography partition `npi` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
