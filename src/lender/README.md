...
> atom `lender` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `lender`
- partition root `a4687099-b1c8-82e8-8a52-ef71bae3bd33`
- bond degree `11`
...
<sub>content-uuid `27de5680-af2f-884a-af9a-deebbfbe4416` · framed by typography partition `lender` bonds `11` · `pnpm readme` · `pnpm readme:check`</sub>
