...
> atom `occupation` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition root `9e3c780e-deee-85aa-ba85-f6df312681a6`
- bond degree `14`
...
<sub>content-uuid `d0c8a1d7-1794-832a-9ea7-c356b06024ed` · framed by typography partition `occupation` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
