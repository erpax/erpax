...
> atom `friction` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `friction`
- partition root `2d3fe81b-44be-892c-b585-64385466a1b2`
- bond degree `31`
...
<sub>content-uuid `e9c83fad-0f15-80f4-936f-bee88b6613d3` · framed by typography partition `friction` bonds `31` · `pnpm readme` · `pnpm readme:check`</sub>
