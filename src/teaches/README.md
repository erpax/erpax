...
> atom `teaches` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `teaches`
- partition root `c412cfba-5b71-8d47-9c6f-c6a85b96bbcd`
- bond degree `12`
...
<sub>content-uuid `8354d73c-5e1b-8069-b54a-e4746badde2b` · framed by typography partition `teaches` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
