...
> atom `failure` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `failure`
- partition root `be7f8f86-7039-82ee-a2ad-40d2f1264301`
- bond degree `11`
...
<sub>content-uuid `c9b71644-133f-830f-8555-f6cf224c5ad9` · framed by typography partition `failure` bonds `11` · `pnpm readme` · `pnpm readme:check`</sub>
