...
> atom `tape` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `tape`
- partition root `deedce52-86b6-85eb-b040-c8e922370b8b`
- bond degree `12`
...
<sub>content-uuid `80982800-cec9-871c-9773-610d32dfbe4a` · framed by typography partition `tape` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
