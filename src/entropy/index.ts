...
/** The bare-implication law lives in its own atom; the hub offers its face. See ./implication. */
export { bareImplications, statesBareImplication, type BareClaim } from './implication'
