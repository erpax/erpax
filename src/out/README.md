...
> atom `out` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `out`
- partition root `27482349-567e-8997-b3c4-a3731c3be3eb`
- bond degree `20`
...
<sub>content-uuid `4ca0a300-c0ef-8dfa-a207-85a9504ed9b0` · framed by typography partition `out` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
