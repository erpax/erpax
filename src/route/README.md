...
> atom `route` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `route`
- partition root `16177fa9-ec86-8e39-9ee8-db515b12971f`
- bond degree `16`
...
<sub>content-uuid `3636fb62-93ac-81a2-bbf6-6621d8ce6154` · framed by typography partition `route` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
