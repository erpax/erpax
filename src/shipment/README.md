...
> atom `shipment` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `shipment`
- partition root `78a4578d-fece-8a77-a156-ab71af8f1dc7`
- bond degree `16`
...
<sub>content-uuid `2461c57c-6313-8728-b7c1-f48d5b8bb6c5` · framed by typography partition `shipment` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
