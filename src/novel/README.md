...
> atom `novel` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `novel`
- partition root `443b6455-6684-8bd2-b8eb-a3de03177692`
- bond degree `12`
...
<sub>content-uuid `894f6199-e664-838a-89b9-809fc74777b2` · framed by typography partition `novel` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
