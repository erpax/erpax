...
> atom `framework` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `framework`
- partition root `5fb795f6-a50b-81e4-a11b-5c35c62fcea2`
- bond degree `14`
...
<sub>content-uuid `af7c07d0-0256-8d99-94fc-f1d992a44fbb` · framed by typography partition `framework` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
