...
> atom `anatomy` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `anatomy`
- partition root `12a41b57-7381-88d5-9fde-0839f0438177`
- bond degree `24`
...
<sub>content-uuid `b33f018c-6a1f-802e-8ff0-08cde136d600` · framed by typography partition `anatomy` bonds `24` · `pnpm readme` · `pnpm readme:check`</sub>
