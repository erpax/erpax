...
> atom `motorized` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `motorized`
- partition root `7b1b815c-b246-8c78-8ef9-b74151e19579`
- bond degree `10`
...
<sub>content-uuid `83707013-178f-8b41-a699-795c0b4784df` · framed by typography partition `motorized` bonds `10` · `pnpm readme` · `pnpm readme:check`</sub>
