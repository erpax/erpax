...
> atom `assesses` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `assesses` · sub-root `996b09a9-0e04-8fdb-8fa2-572638845594`
...
- partition `assesses`
- partition root `996b09a9-0e04-8fdb-8fa2-572638845594`
- bond degree `6`
...
<sub>content-uuid `30e0f786-af60-85fc-b67a-1560cc4d362b` · framed by typography partition `assesses` bonds `6` · `pnpm readme` · `pnpm readme:check`</sub>
