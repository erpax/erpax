...
> atom `contagiousness` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition root `c96ac9bf-e714-8eea-aa2e-0d4400a9f188`
- bond degree `18`
...
<sub>content-uuid `77cfca88-2211-8ec1-8241-455e25c05ea0` · framed by typography partition `contagiousness` bonds `18` · `pnpm readme` · `pnpm readme:check`</sub>
