...
/** Credit for claims in src/get/tenant/from/request/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/get/tenant/from/request/index.ts — leftover wave proof', () => {
