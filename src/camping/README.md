...
> atom `camping` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `camping`
- partition root `c9557763-3903-8fd8-8a3d-c196df954673`
- bond degree `16`
...
<sub>content-uuid `f2173aec-08f3-8b63-bf8c-e18c8c2006ca` · framed by typography partition `camping` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
