...
> atom `does` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `does`
- partition root `b9e8be7d-3508-8a4a-8699-a85b5980d08d`
- bond degree `18`
...
<sub>content-uuid `e9afadb8-a971-8854-9926-002b9709ac1a` · framed by typography partition `does` bonds `18` · `pnpm readme` · `pnpm readme:check`</sub>
