...
> atom `government` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
<sub>content-uuid `6f581f75-b684-8800-a2c2-b4ef12f7285f` · framed by typography partition `government` bonds `51` · `pnpm readme` · `pnpm readme:check`</sub>
