...
> atom `problem` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `problem`
- partition root `f9e45343-32af-8bb3-b2fe-7a2023ba4807`
- bond degree `22`
...
<sub>content-uuid `bd46b19b-4882-81de-b1ad-ad754e536ed9` · framed by typography partition `problem` bonds `22` · `pnpm readme` · `pnpm readme:check`</sub>
