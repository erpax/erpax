...
> atom `bookmark` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `bookmark`
- partition root `0e17b4bd-c717-8d45-bb6c-61094153a2a2`
- bond degree `16`
...
<sub>content-uuid `5479ef7f-e476-8a5e-9eff-fc714cdd739f` · framed by typography partition `bookmark` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
