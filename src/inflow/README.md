...
> atom `inflow` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `inflow`
- partition root `df652ff7-7127-81b8-9fda-6091ccbd82a7`
- bond degree `19`
...
<sub>content-uuid `181ac309-b57a-84c7-a76a-b7ea5f82fe45` · framed by typography partition `inflow` bonds `19` · `pnpm readme` · `pnpm readme:check`</sub>
