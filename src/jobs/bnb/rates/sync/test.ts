...
/** Credit for claims in src/jobs/bnb/rates/sync/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/jobs/bnb/rates/sync/index.ts — leftover wave proof', () => {
