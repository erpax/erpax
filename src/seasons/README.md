...
> atom `seasons` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `seasons`
- partition root `ca7c2133-4bf7-8b32-8f18-f6c31a5697dc`
- bond degree `10`
...
<sub>content-uuid `6b73359e-a0f5-82aa-bff2-8c23fc1424f8` · framed by typography partition `seasons` bonds `10` · `pnpm readme` · `pnpm readme:check`</sub>
