...
> atom `gl/accounts/period/end/adjustments` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
<sub>content-uuid `c112bb82-87a7-83bf-aaaa-c8ebc33360aa` · framed by typography partition `gl` bonds `39` · `pnpm readme` · `pnpm readme:check`</sub>
