...
/** Credit for claims in src/gl/account/resolver/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/gl/account/resolver/index.ts — leftover wave proof', () => {
