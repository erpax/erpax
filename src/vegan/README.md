...
> atom `vegan` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `vegan`
- partition root `e4e31cb8-4eac-8c25-8c8d-ac74754282df`
- bond degree `12`
...
<sub>content-uuid `76b4fc51-ccfd-856c-88e8-065b705e292c` · framed by typography partition `vegan` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
