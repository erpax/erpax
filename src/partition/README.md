...
> atom `partition` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `partition`
- partition root `1d8b654a-8f54-8be2-8503-de37f1d2643e`
- bond degree `30`
...
<sub>content-uuid `95c2cf95-950e-8973-b8b8-8067e33b3230` · framed by typography partition `partition` bonds `30` · `pnpm readme` · `pnpm readme:check`</sub>
