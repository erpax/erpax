...
> atom `funded` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `funded`
- partition root `32ffc05c-9c49-80f1-a0b7-392b1a22195f`
- bond degree `20`
...
<sub>content-uuid `beafce1d-f9ad-8892-aa12-3ae47398ca35` · framed by typography partition `funded` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
