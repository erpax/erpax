...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`taggings_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` text(36) NOT NULL,
  	\`path\` text NOT NULL,
  	...
  	\`users_id\` text(36),
  	\`roles_id\` text(36),
  	\`user_roles_id\` text(36),
  	\`pages_id\` text(36),
  	\`posts_id\` text(36),
  	\`media_id\` text(36),
  	\`categories_id\` text(36),
  	\`invoices_id\` text(36),
  	\`invoice_lines_id\` text(36),
  	\`payment_methods_id\` text(36),
  	\`payments_id\` text(36),
  	\`subscription_plans_id\` text(36),
  	\`subscriptions_id\` text(36),
  	\`items_id\` text(36),
  	\`gl_accounts_id\` text(36),
  	\`gl_posting_rules_id\` text(36),
  	\`journal_entries_id\` text(36),
  	\`gl_postings_id\` text(36),
  	\`period_locks_id\` text(36),
  	\`closing_entries_id\` text(36),
  	\`bank_statements_id\` text(36),
  	\`bank_transactions_id\` text(36),
  	\`bank_accounts_id\` text(36),
  	\`account_reconciliations_id\` text(36),
  	\`bank_reconciliations_id\` text(36),
  	\`financial_statements_id\` text(36),
  	\`period_end_adjustments_id\` text(36),
  	\`recurring_journals_id\` text(36),
  	\`prior_period_adjustments_id\` text(36),
  	\`rounding_adjustments_id\` text(36),
  	\`tax_calculations_id\` text(36),
  	\`tax_codes_id\` text(36),
  	\`tax_jurisdictions_id\` text(36),
  	\`tax_returns_id\` text(36),
  	\`currency_rates_id\` text(36),
  	\`fiscal_periods_id\` text(36),
  	\`fiscal_calendars_id\` text(36),
  	\`fiscal_period_snapshots_id\` text(36),
  	\`fixed_assets_id\` text(36),
  	\`depreciation_schedules_id\` text(36),
  	\`customers_id\` text(36),
  	\`leads_id\` text(36),
  	\`opportunities_id\` text(36),
  	\`customer_segments_id\` text(36),
  	\`quotes_id\` text(36),
  	\`sales_orders_id\` text(36),
  	\`sales_commissions_id\` text(36),
  	\`credit_memos_id\` text(36),
  	\`returns_id\` text(36),
  	\`shipments_id\` text(36),
  	\`refunds_id\` text(36),
  	\`payment_allocations_id\` text(36),
  	\`dunning_cycles_id\` text(36),
  	\`vendors_id\` text(36),
  	\`vendor_quotes_id\` text(36),
  	\`vendor_scorecards_id\` text(36),
  	\`purchase_orders_id\` text(36),
  	\`purchase_requisitions_id\` text(36),
  	\`goods_receipts_id\` text(36),
  	\`inventory_movements_id\` text(36),
  	\`warehouse_locations_id\` text(36),
  	\`cost_centers_id\` text(36),
  	\`budget_planning_id\` text(36),
  	\`cost_variances_id\` text(36),
  	\`intercompany_transactions_id\` text(36),
  	\`consolidation_eliminations_id\` text(36),
  	\`fx_transactions_id\` text(36),
  	\`contracts_id\` text(36),
  	\`performance_obligations_id\` text(36),
  	\`commitments_and_contingencies_id\` text(36),
  	\`leases_id\` text(36),
  	\`lease_modifications_id\` text(36),
  	\`lease_period_postings_id\` text(36),
  	\`payment_runs_id\` text(36),
  	\`sepa_mandates_id\` text(36),
  	\`payroll_runs_id\` text(36),
  	\`employees_id\` text(36),
  	\`job_positions_id\` text(36),
  	\`time_entries_id\` text(36),
  	\`leave_requests_id\` text(36),
  	\`performance_reviews_id\` text(36),
  	\`expense_reports_id\` text(36),
  	\`recruiting_pipeline_id\` text(36),
  	\`activities_id\` text(36),
  	\`projects_id\` text(36),
  	\`project_tasks_id\` text(36),
  	\`project_milestones_id\` text(36),
  	\`work_orders_id\` text(36),
  	\`workflow_definitions_id\` text(36),
  	\`workflow_instances_id\` text(36),
  	\`bills_of_materials_id\` text(36),
  	\`work_centers_id\` text(36),
  	\`work_shifts_id\` text(36),
  	\`operations_id\` text(36),
  	\`routings_id\` text(36),
  	\`operation_runs_id\` text(36),
  	\`production_receipts_id\` text(36),
  	\`quality_inspections_id\` text(36),
  	\`wip_snapshots_id\` text(36),
  	\`properties_id\` text(36),
  	\`spaces_id\` text(36),
  	\`maintenance_requests_id\` text(36),
  	\`maintenance_work_orders_id\` text(36),
  	\`bookable_resources_id\` text(36),
  	\`bookings_id\` text(36),
  	\`carriers_id\` text(36),
  	\`tracking_events_id\` text(36),
  	\`customs_declarations_id\` text(36),
  	\`consignment_arrangements_id\` text(36),
  	\`consignment_inventory_id\` text(36),
  	\`consignment_sales_id\` text(36),
  	\`audit_events_id\` text(36),
  	\`api_audit_events_id\` text(36),
  	\`evidence_attestations_id\` text(36),
  	\`entity_types_id\` text(36),
  	\`taxing_jurisdictions_id\` text(36),
  	\`entity_legal_structures_id\` text(36),
  	\`compliance_frameworks_id\` text(36),
  	\`compliance_requirements_id\` text(36),
  	\`internal_controls_id\` text(36),
  	\`control_tests_id\` text(36),
  	\`audit_samples_id\` text(36),
  	\`compliance_gaps_id\` text(36),
  	\`audit_evidence_id\` text(36),
  	\`audit_findings_id\` text(36),
  	\`audit_trail_events_id\` text(36),
  	\`remediation_plans_id\` text(36),
  	\`audit_committees_id\` text(36),
  	\`audit_committee_members_id\` text(36),
  	\`board_actions_id\` text(36),
  	\`management_certifications_id\` text(36),
  	\`regulatory_reports_id\` text(36),
  	\`internal_policies_id\` text(36),
  	\`statutory_report_templates_id\` text(36),
  	\`statutory_field_mappings_id\` text(36),
  	\`policy_versions_id\` text(36),
  	\`policy_acknowledgments_id\` text(36),
  	\`compliance_deadlines_id\` text(36),
  	\`compliance_notifications_id\` text(36),
  	\`reporting_standards_id\` text(36),
  	\`reporting_mappings_id\` text(36),
  	\`related_party_transactions_id\` text(36),
  	\`management_assessment_icfr_id\` text(36),
  	\`disclosure_checklists_id\` text(36),
  	\`audit_committee_minutes_id\` text(36),
  	\`risk_register_id\` text(36),
  	\`debt_schedule_id\` text(36),
  	\`internal_audit_function_id\` text(36),
  	\`segment_reporting_id\` text(36),
  	\`consent_records_id\` text(36),
  	\`data_subject_requests_id\` text(36),
  	\`data_processing_activities_id\` text(36),
  	\`kyc_checks_id\` text(36),
  	\`beneficial_owners_id\` text(36),
  	\`csrd_disclosures_id\` text(36),
  	\`carbon_emissions_id\` text(36),
  	\`biological_assets_id\` text(36),
  	\`mineral_resource_assets_id\` text(36),
  	\`investment_properties_id\` text(36),
  	\`provisions_id\` text(36),
  	\`government_grants_id\` text(36),
  	\`deferred_tax_items_id\` text(36),
  	\`share_based_payments_id\` text(36),
  	\`business_combinations_id\` text(36),
  	\`held_for_sale_classifications_id\` text(36),
  	\`fair_value_measurements_id\` text(36),
  	\`earnings_per_share_id\` text(36),
  	\`insurance_contracts_id\` text(36),
  	\`regulatory_deferral_accounts_id\` text(36),
  	\`post_balance_sheet_events_id\` text(36),
  	\`transaction_failures_id\` text(36),
  	\`transfer_pricing_files_id\` text(36),
  	\`standards_id\` text(36),
  	\`memories_id\` text(36),
  	\`mcp_tool_metadata_id\` text(36),
  	\`translations_id\` text(36),
  	\`commitments_id\` text(36),
  	\`contract_amendments_id\` text(36),
  	\`contract_performance_id\` text(36),
  	\`contract_signatures_id\` text(36),
  	\`contract_templates_id\` text(36),
  	\`legal_entities_id\` text(36),
  	\`ai_suggestions_id\` text(36),
  	\`usage_records_id\` text(36),
  	\`consolidations_id\` text(36),
  	\`tax_periods_id\` text(36),
  	\`audit_reports_id\` text(36),
  	\`transfer_pricing_adjustments_id\` text(36),
  	\`post_close_analytics_reports_id\` text(36),
  	\`addresses_id\` text(36),
  	\`variants_id\` text(36),
  	...
  	\`exports_id\` text(36),
  	\`imports_id\` text(36),
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`taggings\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`tenants_id\`) REFERENCES \`tenants\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`users_id\`) REFERENCES \`users\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`gl_accounts_id\`) REFERENCES \`gl_accounts\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`gl_posting_rules_id\`) REFERENCES \`gl_posting_rules\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`period_locks_id\`) REFERENCES \`period_locks\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`closing_entries_id\`) REFERENCES \`closing_entries\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`bank_reconciliations_id\`) REFERENCES \`bank_reconciliations\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`recurring_journals_id\`) REFERENCES \`recurring_journals\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`prior_period_adjustments_id\`) REFERENCES \`prior_period_adjustments\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`rounding_adjustments_id\`) REFERENCES \`rounding_adjustments\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`tax_calculations_id\`) REFERENCES \`tax_calculations\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`tax_codes_id\`) REFERENCES \`tax_codes\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`fiscal_calendars_id\`) REFERENCES \`fiscal_calendars\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`fiscal_period_snapshots_id\`) REFERENCES \`fiscal_period_snapshots\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`customer_segments_id\`) REFERENCES \`customer_segments\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`sales_commissions_id\`) REFERENCES \`sales_commissions\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`payment_allocations_id\`) REFERENCES \`payment_allocations\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`vendor_quotes_id\`) REFERENCES \`vendor_quotes\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`vendor_scorecards_id\`) REFERENCES \`vendor_scorecards\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`purchase_orders_id\`) REFERENCES \`purchase_orders\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`purchase_requisitions_id\`) REFERENCES \`purchase_requisitions\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`cost_variances_id\`) REFERENCES \`cost_variances\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`intercompany_transactions_id\`) REFERENCES \`intercompany_transactions\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`consolidation_eliminations_id\`) REFERENCES \`consolidation_eliminations\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`commitments_and_contingencies_id\`) REFERENCES \`commitments_and_contingencies\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`leases_id\`) REFERENCES \`leases\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`lease_modifications_id\`) REFERENCES \`lease_modifications\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`job_positions_id\`) REFERENCES \`job_positions\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`time_entries_id\`) REFERENCES \`time_entries\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`leave_requests_id\`) REFERENCES \`leave_requests\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`performance_reviews_id\`) REFERENCES \`performance_reviews\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`expense_reports_id\`) REFERENCES \`expense_reports\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`recruiting_pipeline_id\`) REFERENCES \`recruiting_pipeline\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`activities_id\`) REFERENCES \`activities\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`projects_id\`) REFERENCES \`projects\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`project_tasks_id\`) REFERENCES \`project_tasks\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`project_milestones_id\`) REFERENCES \`project_milestones\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`work_orders_id\`) REFERENCES \`work_orders\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`workflow_definitions_id\`) REFERENCES \`workflow_definitions\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`workflow_instances_id\`) REFERENCES \`workflow_instances\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`bills_of_materials_id\`) REFERENCES \`bills_of_materials\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`work_centers_id\`) REFERENCES \`work_centers\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`work_shifts_id\`) REFERENCES \`work_shifts\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`operations_id\`) REFERENCES \`operations\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`routings_id\`) REFERENCES \`routings\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`operation_runs_id\`) REFERENCES \`operation_runs\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`production_receipts_id\`) REFERENCES \`production_receipts\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`quality_inspections_id\`) REFERENCES \`quality_inspections\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`wip_snapshots_id\`) REFERENCES \`wip_snapshots\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`properties_id\`) REFERENCES \`properties\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`spaces_id\`) REFERENCES \`spaces\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`maintenance_requests_id\`) REFERENCES \`maintenance_requests\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`maintenance_work_orders_id\`) REFERENCES \`maintenance_work_orders\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`bookable_resources_id\`) REFERENCES \`bookable_resources\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`bookings_id\`) REFERENCES \`bookings\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`carriers_id\`) REFERENCES \`carriers\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`tracking_events_id\`) REFERENCES \`tracking_events\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`customs_declarations_id\`) REFERENCES \`customs_declarations\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`consignment_arrangements_id\`) REFERENCES \`consignment_arrangements\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`consignment_inventory_id\`) REFERENCES \`consignment_inventory\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`consignment_sales_id\`) REFERENCES \`consignment_sales\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`audit_events_id\`) REFERENCES \`audit_events\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`api_audit_events_id\`) REFERENCES \`api_audit_events\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`evidence_attestations_id\`) REFERENCES \`evidence_attestations\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`entity_legal_structures_id\`) REFERENCES \`entity_legal_structures\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`audit_samples_id\`) REFERENCES \`audit_samples\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`audit_trail_events_id\`) REFERENCES \`audit_trail_events\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`remediation_plans_id\`) REFERENCES \`remediation_plans\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`audit_committees_id\`) REFERENCES \`audit_committees\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`management_certifications_id\`) REFERENCES \`management_certifications\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`regulatory_reports_id\`) REFERENCES \`regulatory_reports\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`internal_policies_id\`) REFERENCES \`internal_policies\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`statutory_report_templates_id\`) REFERENCES \`statutory_report_templates\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`statutory_field_mappings_id\`) REFERENCES \`statutory_field_mappings\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`policy_versions_id\`) REFERENCES \`policy_versions\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`policy_acknowledgments_id\`) REFERENCES \`policy_acknowledgments\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`compliance_deadlines_id\`) REFERENCES \`compliance_deadlines\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`compliance_notifications_id\`) REFERENCES \`compliance_notifications\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`reporting_standards_id\`) REFERENCES \`reporting_standards\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`reporting_mappings_id\`) REFERENCES \`reporting_mappings\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`related_party_transactions_id\`) REFERENCES \`related_party_transactions\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`management_assessment_icfr_id\`) REFERENCES \`management_assessment_icfr\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`risk_register_id\`) REFERENCES \`risk_register\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`debt_schedule_id\`) REFERENCES \`debt_schedule\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`internal_audit_function_id\`) REFERENCES \`internal_audit_function\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`segment_reporting_id\`) REFERENCES \`segment_reporting\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`csrd_disclosures_id\`) REFERENCES \`csrd_disclosures\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`carbon_emissions_id\`) REFERENCES \`carbon_emissions\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`biological_assets_id\`) REFERENCES \`biological_assets\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`mineral_resource_assets_id\`) REFERENCES \`mineral_resource_assets\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`investment_properties_id\`) REFERENCES \`investment_properties\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`provisions_id\`) REFERENCES \`provisions\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`government_grants_id\`) REFERENCES \`government_grants\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`deferred_tax_items_id\`) REFERENCES \`deferred_tax_items\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`share_based_payments_id\`) REFERENCES \`share_based_payments\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`business_combinations_id\`) REFERENCES \`business_combinations\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`held_for_sale_classifications_id\`) REFERENCES \`held_for_sale_classifications\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`fair_value_measurements_id\`) REFERENCES \`fair_value_measurements\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`earnings_per_share_id\`) REFERENCES \`earnings_per_share\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`insurance_contracts_id\`) REFERENCES \`insurance_contracts\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`regulatory_deferral_accounts_id\`) REFERENCES \`regulatory_deferral_accounts\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`post_balance_sheet_events_id\`) REFERENCES \`post_balance_sheet_events\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`transaction_failures_id\`) REFERENCES \`transaction_failures\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`transfer_pricing_files_id\`) REFERENCES \`transfer_pricing_files\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`standards_id\`) REFERENCES \`standards\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`memories_id\`) REFERENCES \`memories\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`mcp_tool_metadata_id\`) REFERENCES \`mcp_tool_metadata\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`translations_id\`) REFERENCES \`translations\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`commitments_id\`) REFERENCES \`commitments\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`contract_amendments_id\`) REFERENCES \`contract_amendments\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`contract_performance_id\`) REFERENCES \`contract_performance\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`contract_signatures_id\`) REFERENCES \`contract_signatures\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`contract_templates_id\`) REFERENCES \`contract_templates\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`legal_entities_id\`) REFERENCES \`legal_entities\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`ai_suggestions_id\`) REFERENCES \`ai_suggestions\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`usage_records_id\`) REFERENCES \`usage_records\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`consolidations_id\`) REFERENCES \`consolidations\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`tax_periods_id\`) REFERENCES \`tax_periods\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`audit_reports_id\`) REFERENCES \`audit_reports\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`transfer_pricing_adjustments_id\`) REFERENCES \`transfer_pricing_adjustments\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`post_close_analytics_reports_id\`) REFERENCES \`post_close_analytics_reports\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`addresses_id\`) REFERENCES \`addresses\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	...
  	FOREIGN KEY (\`imports_id\`) REFERENCES \`imports\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`taggings_rels_order_idx\` ON \`taggings_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_parent_idx\` ON \`taggings_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_path_idx\` ON \`taggings_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_tenants_id_idx\` ON \`taggings_rels\` (\`tenants_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_users_id_idx\` ON \`taggings_rels\` (\`users_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_roles_id_idx\` ON \`taggings_rels\` (\`roles_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_user_roles_id_idx\` ON \`taggings_rels\` (\`user_roles_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_pages_id_idx\` ON \`taggings_rels\` (\`pages_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_posts_id_idx\` ON \`taggings_rels\` (\`posts_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_media_id_idx\` ON \`taggings_rels\` (\`media_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_categories_id_idx\` ON \`taggings_rels\` (\`categories_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_invoices_id_idx\` ON \`taggings_rels\` (\`invoices_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_invoice_lines_id_idx\` ON \`taggings_rels\` (\`invoice_lines_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_payment_methods_id_idx\` ON \`taggings_rels\` (\`payment_methods_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_payments_id_idx\` ON \`taggings_rels\` (\`payments_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_subscription_plans_id_idx\` ON \`taggings_rels\` (\`subscription_plans_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_subscriptions_id_idx\` ON \`taggings_rels\` (\`subscriptions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_items_id_idx\` ON \`taggings_rels\` (\`items_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_gl_accounts_id_idx\` ON \`taggings_rels\` (\`gl_accounts_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_gl_posting_rules_id_idx\` ON \`taggings_rels\` (\`gl_posting_rules_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_journal_entries_id_idx\` ON \`taggings_rels\` (\`journal_entries_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_gl_postings_id_idx\` ON \`taggings_rels\` (\`gl_postings_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_period_locks_id_idx\` ON \`taggings_rels\` (\`period_locks_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_closing_entries_id_idx\` ON \`taggings_rels\` (\`closing_entries_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_bank_statements_id_idx\` ON \`taggings_rels\` (\`bank_statements_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_bank_transactions_id_idx\` ON \`taggings_rels\` (\`bank_transactions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_bank_accounts_id_idx\` ON \`taggings_rels\` (\`bank_accounts_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_account_reconciliations_id_idx\` ON \`taggings_rels\` (\`account_reconciliations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_bank_reconciliations_id_idx\` ON \`taggings_rels\` (\`bank_reconciliations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_financial_statements_id_idx\` ON \`taggings_rels\` (\`financial_statements_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_period_end_adjustments_id_idx\` ON \`taggings_rels\` (\`period_end_adjustments_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_recurring_journals_id_idx\` ON \`taggings_rels\` (\`recurring_journals_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_prior_period_adjustments_id_idx\` ON \`taggings_rels\` (\`prior_period_adjustments_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_rounding_adjustments_id_idx\` ON \`taggings_rels\` (\`rounding_adjustments_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_tax_calculations_id_idx\` ON \`taggings_rels\` (\`tax_calculations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_tax_codes_id_idx\` ON \`taggings_rels\` (\`tax_codes_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_tax_jurisdictions_id_idx\` ON \`taggings_rels\` (\`tax_jurisdictions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_tax_returns_id_idx\` ON \`taggings_rels\` (\`tax_returns_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_currency_rates_id_idx\` ON \`taggings_rels\` (\`currency_rates_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_fiscal_periods_id_idx\` ON \`taggings_rels\` (\`fiscal_periods_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_fiscal_calendars_id_idx\` ON \`taggings_rels\` (\`fiscal_calendars_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_fiscal_period_snapshots_id_idx\` ON \`taggings_rels\` (\`fiscal_period_snapshots_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_fixed_assets_id_idx\` ON \`taggings_rels\` (\`fixed_assets_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_depreciation_schedules_id_idx\` ON \`taggings_rels\` (\`depreciation_schedules_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_customers_id_idx\` ON \`taggings_rels\` (\`customers_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_leads_id_idx\` ON \`taggings_rels\` (\`leads_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_opportunities_id_idx\` ON \`taggings_rels\` (\`opportunities_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_customer_segments_id_idx\` ON \`taggings_rels\` (\`customer_segments_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_quotes_id_idx\` ON \`taggings_rels\` (\`quotes_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_sales_orders_id_idx\` ON \`taggings_rels\` (\`sales_orders_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_sales_commissions_id_idx\` ON \`taggings_rels\` (\`sales_commissions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_credit_memos_id_idx\` ON \`taggings_rels\` (\`credit_memos_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_returns_id_idx\` ON \`taggings_rels\` (\`returns_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_shipments_id_idx\` ON \`taggings_rels\` (\`shipments_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_refunds_id_idx\` ON \`taggings_rels\` (\`refunds_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_payment_allocations_id_idx\` ON \`taggings_rels\` (\`payment_allocations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_dunning_cycles_id_idx\` ON \`taggings_rels\` (\`dunning_cycles_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_vendors_id_idx\` ON \`taggings_rels\` (\`vendors_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_vendor_quotes_id_idx\` ON \`taggings_rels\` (\`vendor_quotes_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_vendor_scorecards_id_idx\` ON \`taggings_rels\` (\`vendor_scorecards_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_purchase_orders_id_idx\` ON \`taggings_rels\` (\`purchase_orders_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_purchase_requisitions_id_idx\` ON \`taggings_rels\` (\`purchase_requisitions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_goods_receipts_id_idx\` ON \`taggings_rels\` (\`goods_receipts_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_inventory_movements_id_idx\` ON \`taggings_rels\` (\`inventory_movements_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_warehouse_locations_id_idx\` ON \`taggings_rels\` (\`warehouse_locations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_cost_centers_id_idx\` ON \`taggings_rels\` (\`cost_centers_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_budget_planning_id_idx\` ON \`taggings_rels\` (\`budget_planning_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_cost_variances_id_idx\` ON \`taggings_rels\` (\`cost_variances_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_intercompany_transactions_id_idx\` ON \`taggings_rels\` (\`intercompany_transactions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_consolidation_eliminations_id_idx\` ON \`taggings_rels\` (\`consolidation_eliminations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_fx_transactions_id_idx\` ON \`taggings_rels\` (\`fx_transactions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_contracts_id_idx\` ON \`taggings_rels\` (\`contracts_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_performance_obligations_id_idx\` ON \`taggings_rels\` (\`performance_obligations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_commitments_and_contingencies_id_idx\` ON \`taggings_rels\` (\`commitments_and_contingencies_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_leases_id_idx\` ON \`taggings_rels\` (\`leases_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_lease_modifications_id_idx\` ON \`taggings_rels\` (\`lease_modifications_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_lease_period_postings_id_idx\` ON \`taggings_rels\` (\`lease_period_postings_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_payment_runs_id_idx\` ON \`taggings_rels\` (\`payment_runs_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_sepa_mandates_id_idx\` ON \`taggings_rels\` (\`sepa_mandates_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_payroll_runs_id_idx\` ON \`taggings_rels\` (\`payroll_runs_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_employees_id_idx\` ON \`taggings_rels\` (\`employees_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_job_positions_id_idx\` ON \`taggings_rels\` (\`job_positions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_time_entries_id_idx\` ON \`taggings_rels\` (\`time_entries_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_leave_requests_id_idx\` ON \`taggings_rels\` (\`leave_requests_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_performance_reviews_id_idx\` ON \`taggings_rels\` (\`performance_reviews_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_expense_reports_id_idx\` ON \`taggings_rels\` (\`expense_reports_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_recruiting_pipeline_id_idx\` ON \`taggings_rels\` (\`recruiting_pipeline_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_activities_id_idx\` ON \`taggings_rels\` (\`activities_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_projects_id_idx\` ON \`taggings_rels\` (\`projects_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_project_tasks_id_idx\` ON \`taggings_rels\` (\`project_tasks_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_project_milestones_id_idx\` ON \`taggings_rels\` (\`project_milestones_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_work_orders_id_idx\` ON \`taggings_rels\` (\`work_orders_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_workflow_definitions_id_idx\` ON \`taggings_rels\` (\`workflow_definitions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_workflow_instances_id_idx\` ON \`taggings_rels\` (\`workflow_instances_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_bills_of_materials_id_idx\` ON \`taggings_rels\` (\`bills_of_materials_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_work_centers_id_idx\` ON \`taggings_rels\` (\`work_centers_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_work_shifts_id_idx\` ON \`taggings_rels\` (\`work_shifts_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_operations_id_idx\` ON \`taggings_rels\` (\`operations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_routings_id_idx\` ON \`taggings_rels\` (\`routings_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_operation_runs_id_idx\` ON \`taggings_rels\` (\`operation_runs_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_production_receipts_id_idx\` ON \`taggings_rels\` (\`production_receipts_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_quality_inspections_id_idx\` ON \`taggings_rels\` (\`quality_inspections_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_wip_snapshots_id_idx\` ON \`taggings_rels\` (\`wip_snapshots_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_properties_id_idx\` ON \`taggings_rels\` (\`properties_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_spaces_id_idx\` ON \`taggings_rels\` (\`spaces_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_maintenance_requests_id_idx\` ON \`taggings_rels\` (\`maintenance_requests_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_maintenance_work_orders_id_idx\` ON \`taggings_rels\` (\`maintenance_work_orders_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_bookable_resources_id_idx\` ON \`taggings_rels\` (\`bookable_resources_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_bookings_id_idx\` ON \`taggings_rels\` (\`bookings_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_carriers_id_idx\` ON \`taggings_rels\` (\`carriers_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_tracking_events_id_idx\` ON \`taggings_rels\` (\`tracking_events_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_customs_declarations_id_idx\` ON \`taggings_rels\` (\`customs_declarations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_consignment_arrangements_id_idx\` ON \`taggings_rels\` (\`consignment_arrangements_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_consignment_inventory_id_idx\` ON \`taggings_rels\` (\`consignment_inventory_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_consignment_sales_id_idx\` ON \`taggings_rels\` (\`consignment_sales_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_audit_events_id_idx\` ON \`taggings_rels\` (\`audit_events_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_api_audit_events_id_idx\` ON \`taggings_rels\` (\`api_audit_events_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_evidence_attestations_id_idx\` ON \`taggings_rels\` (\`evidence_attestations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_entity_types_id_idx\` ON \`taggings_rels\` (\`entity_types_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_taxing_jurisdictions_id_idx\` ON \`taggings_rels\` (\`taxing_jurisdictions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_entity_legal_structures_id_idx\` ON \`taggings_rels\` (\`entity_legal_structures_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_compliance_frameworks_id_idx\` ON \`taggings_rels\` (\`compliance_frameworks_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_compliance_requirements_id_idx\` ON \`taggings_rels\` (\`compliance_requirements_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_internal_controls_id_idx\` ON \`taggings_rels\` (\`internal_controls_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_control_tests_id_idx\` ON \`taggings_rels\` (\`control_tests_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_audit_samples_id_idx\` ON \`taggings_rels\` (\`audit_samples_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_compliance_gaps_id_idx\` ON \`taggings_rels\` (\`compliance_gaps_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_audit_evidence_id_idx\` ON \`taggings_rels\` (\`audit_evidence_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_audit_findings_id_idx\` ON \`taggings_rels\` (\`audit_findings_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_audit_trail_events_id_idx\` ON \`taggings_rels\` (\`audit_trail_events_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_remediation_plans_id_idx\` ON \`taggings_rels\` (\`remediation_plans_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_audit_committees_id_idx\` ON \`taggings_rels\` (\`audit_committees_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_audit_committee_members_id_idx\` ON \`taggings_rels\` (\`audit_committee_members_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_board_actions_id_idx\` ON \`taggings_rels\` (\`board_actions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_management_certifications_id_idx\` ON \`taggings_rels\` (\`management_certifications_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_regulatory_reports_id_idx\` ON \`taggings_rels\` (\`regulatory_reports_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_internal_policies_id_idx\` ON \`taggings_rels\` (\`internal_policies_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_statutory_report_templates_id_idx\` ON \`taggings_rels\` (\`statutory_report_templates_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_statutory_field_mappings_id_idx\` ON \`taggings_rels\` (\`statutory_field_mappings_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_policy_versions_id_idx\` ON \`taggings_rels\` (\`policy_versions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_policy_acknowledgments_id_idx\` ON \`taggings_rels\` (\`policy_acknowledgments_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_compliance_deadlines_id_idx\` ON \`taggings_rels\` (\`compliance_deadlines_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_compliance_notifications_id_idx\` ON \`taggings_rels\` (\`compliance_notifications_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_reporting_standards_id_idx\` ON \`taggings_rels\` (\`reporting_standards_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_reporting_mappings_id_idx\` ON \`taggings_rels\` (\`reporting_mappings_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_related_party_transactions_id_idx\` ON \`taggings_rels\` (\`related_party_transactions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_management_assessment_icfr_id_idx\` ON \`taggings_rels\` (\`management_assessment_icfr_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_disclosure_checklists_id_idx\` ON \`taggings_rels\` (\`disclosure_checklists_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_audit_committee_minutes_id_idx\` ON \`taggings_rels\` (\`audit_committee_minutes_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_risk_register_id_idx\` ON \`taggings_rels\` (\`risk_register_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_debt_schedule_id_idx\` ON \`taggings_rels\` (\`debt_schedule_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_internal_audit_function_id_idx\` ON \`taggings_rels\` (\`internal_audit_function_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_segment_reporting_id_idx\` ON \`taggings_rels\` (\`segment_reporting_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_consent_records_id_idx\` ON \`taggings_rels\` (\`consent_records_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_data_subject_requests_id_idx\` ON \`taggings_rels\` (\`data_subject_requests_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_data_processing_activities_id_idx\` ON \`taggings_rels\` (\`data_processing_activities_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_kyc_checks_id_idx\` ON \`taggings_rels\` (\`kyc_checks_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_beneficial_owners_id_idx\` ON \`taggings_rels\` (\`beneficial_owners_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_csrd_disclosures_id_idx\` ON \`taggings_rels\` (\`csrd_disclosures_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_carbon_emissions_id_idx\` ON \`taggings_rels\` (\`carbon_emissions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_biological_assets_id_idx\` ON \`taggings_rels\` (\`biological_assets_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_mineral_resource_assets_id_idx\` ON \`taggings_rels\` (\`mineral_resource_assets_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_investment_properties_id_idx\` ON \`taggings_rels\` (\`investment_properties_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_provisions_id_idx\` ON \`taggings_rels\` (\`provisions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_government_grants_id_idx\` ON \`taggings_rels\` (\`government_grants_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_deferred_tax_items_id_idx\` ON \`taggings_rels\` (\`deferred_tax_items_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_share_based_payments_id_idx\` ON \`taggings_rels\` (\`share_based_payments_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_business_combinations_id_idx\` ON \`taggings_rels\` (\`business_combinations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_held_for_sale_classifications_id_idx\` ON \`taggings_rels\` (\`held_for_sale_classifications_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_fair_value_measurements_id_idx\` ON \`taggings_rels\` (\`fair_value_measurements_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_earnings_per_share_id_idx\` ON \`taggings_rels\` (\`earnings_per_share_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_insurance_contracts_id_idx\` ON \`taggings_rels\` (\`insurance_contracts_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_regulatory_deferral_accounts_id_idx\` ON \`taggings_rels\` (\`regulatory_deferral_accounts_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_post_balance_sheet_events_id_idx\` ON \`taggings_rels\` (\`post_balance_sheet_events_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_transaction_failures_id_idx\` ON \`taggings_rels\` (\`transaction_failures_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_transfer_pricing_files_id_idx\` ON \`taggings_rels\` (\`transfer_pricing_files_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_standards_id_idx\` ON \`taggings_rels\` (\`standards_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_memories_id_idx\` ON \`taggings_rels\` (\`memories_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_mcp_tool_metadata_id_idx\` ON \`taggings_rels\` (\`mcp_tool_metadata_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_translations_id_idx\` ON \`taggings_rels\` (\`translations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_commitments_id_idx\` ON \`taggings_rels\` (\`commitments_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_contract_amendments_id_idx\` ON \`taggings_rels\` (\`contract_amendments_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_contract_performance_id_idx\` ON \`taggings_rels\` (\`contract_performance_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_contract_signatures_id_idx\` ON \`taggings_rels\` (\`contract_signatures_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_contract_templates_id_idx\` ON \`taggings_rels\` (\`contract_templates_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_legal_entities_id_idx\` ON \`taggings_rels\` (\`legal_entities_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_ai_suggestions_id_idx\` ON \`taggings_rels\` (\`ai_suggestions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_usage_records_id_idx\` ON \`taggings_rels\` (\`usage_records_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_consolidations_id_idx\` ON \`taggings_rels\` (\`consolidations_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_tax_periods_id_idx\` ON \`taggings_rels\` (\`tax_periods_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_audit_reports_id_idx\` ON \`taggings_rels\` (\`audit_reports_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_transfer_pricing_adjustments_id_idx\` ON \`taggings_rels\` (\`transfer_pricing_adjustments_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_post_close_analytics_reports_id_idx\` ON \`taggings_rels\` (\`post_close_analytics_reports_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_addresses_id_idx\` ON \`taggings_rels\` (\`addresses_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_variants_id_idx\` ON \`taggings_rels\` (\`variants_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_variant_types_id_idx\` ON \`taggings_rels\` (\`variant_types_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_variant_options_id_idx\` ON \`taggings_rels\` (\`variant_options_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_products_id_idx\` ON \`taggings_rels\` (\`products_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_carts_id_idx\` ON \`taggings_rels\` (\`carts_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_orders_id_idx\` ON \`taggings_rels\` (\`orders_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_transactions_id_idx\` ON \`taggings_rels\` (\`transactions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_forms_id_idx\` ON \`taggings_rels\` (\`forms_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_form_submissions_id_idx\` ON \`taggings_rels\` (\`form_submissions_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_exports_id_idx\` ON \`taggings_rels\` (\`exports_id\`);`)
  await db.run(sql`CREATE INDEX \`taggings_rels_imports_id_idx\` ON \`taggings_rels\` (\`imports_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`payload_locked_documents_rels\` (
  	...
  	FOREIGN KEY (\`taggings_id\`) REFERENCES \`taggings\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`properties_id\`) REFERENCES \`properties\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`spaces_id\`) REFERENCES \`spaces\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`maintenance_requests_id\`) REFERENCES \`maintenance_requests\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`maintenance_work_orders_id\`) REFERENCES \`maintenance_work_orders\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_gl_posting_rules_id_idx\` ON \`payload_locked_documents_rels\` (\`gl_posting_rules_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_period_locks_id_idx\` ON \`payload_locked_documents_rels\` (\`period_locks_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_closing_entries_id_idx\` ON \`payload_locked_documents_rels\` (\`closing_entries_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_bank_reconciliations_id_idx\` ON \`payload_locked_documents_rels\` (\`bank_reconciliations_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_recurring_journals_id_idx\` ON \`payload_locked_documents_rels\` (\`recurring_journals_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_prior_period_adjustments_i_idx\` ON \`payload_locked_documents_rels\` (\`prior_period_adjustments_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_rounding_adjustments_id_idx\` ON \`payload_locked_documents_rels\` (\`rounding_adjustments_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_fiscal_calendars_id_idx\` ON \`payload_locked_documents_rels\` (\`fiscal_calendars_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_fiscal_period_snapshots_id_idx\` ON \`payload_locked_documents_rels\` (\`fiscal_period_snapshots_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_customer_segments_id_idx\` ON \`payload_locked_documents_rels\` (\`customer_segments_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_quotes_id_idx\` ON \`payload_locked_documents_rels\` (\`quotes_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_sales_orders_id_idx\` ON \`payload_locked_documents_rels\` (\`sales_orders_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_sales_commissions_id_idx\` ON \`payload_locked_documents_rels\` (\`sales_commissions_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_payment_allocations_id_idx\` ON \`payload_locked_documents_rels\` (\`payment_allocations_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_vendor_quotes_id_idx\` ON \`payload_locked_documents_rels\` (\`vendor_quotes_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_vendor_scorecards_id_idx\` ON \`payload_locked_documents_rels\` (\`vendor_scorecards_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_purchase_requisitions_id_idx\` ON \`payload_locked_documents_rels\` (\`purchase_requisitions_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_cost_variances_id_idx\` ON \`payload_locked_documents_rels\` (\`cost_variances_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_intercompany_transactions__idx\` ON \`payload_locked_documents_rels\` (\`intercompany_transactions_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_consolidation_eliminations_idx\` ON \`payload_locked_documents_rels\` (\`consolidation_eliminations_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_fx_transactions_id_idx\` ON \`payload_locked_documents_rels\` (\`fx_transactions_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_commitments_and_contingenc_idx\` ON \`payload_locked_documents_rels\` (\`commitments_and_contingencies_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_leases_id_idx\` ON \`payload_locked_documents_rels\` (\`leases_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_lease_modifications_id_idx\` ON \`payload_locked_documents_rels\` (\`lease_modifications_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_job_positions_id_idx\` ON \`payload_locked_documents_rels\` (\`job_positions_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_leave_requests_id_idx\` ON \`payload_locked_documents_rels\` (\`leave_requests_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_performance_reviews_id_idx\` ON \`payload_locked_documents_rels\` (\`performance_reviews_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_expense_reports_id_idx\` ON \`payload_locked_documents_rels\` (\`expense_reports_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_recruiting_pipeline_id_idx\` ON \`payload_locked_documents_rels\` (\`recruiting_pipeline_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_project_tasks_id_idx\` ON \`payload_locked_documents_rels\` (\`project_tasks_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_project_milestones_id_idx\` ON \`payload_locked_documents_rels\` (\`project_milestones_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_work_orders_id_idx\` ON \`payload_locked_documents_rels\` (\`work_orders_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_workflow_definitions_id_idx\` ON \`payload_locked_documents_rels\` (\`workflow_definitions_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_workflow_instances_id_idx\` ON \`payload_locked_documents_rels\` (\`workflow_instances_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_bills_of_materials_id_idx\` ON \`payload_locked_documents_rels\` (\`bills_of_materials_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_work_centers_id_idx\` ON \`payload_locked_documents_rels\` (\`work_centers_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_work_shifts_id_idx\` ON \`payload_locked_documents_rels\` (\`work_shifts_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_routings_id_idx\` ON \`payload_locked_documents_rels\` (\`routings_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_operation_runs_id_idx\` ON \`payload_locked_documents_rels\` (\`operation_runs_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_production_receipts_id_idx\` ON \`payload_locked_documents_rels\` (\`production_receipts_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_quality_inspections_id_idx\` ON \`payload_locked_documents_rels\` (\`quality_inspections_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_wip_snapshots_id_idx\` ON \`payload_locked_documents_rels\` (\`wip_snapshots_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_tags_id_idx\` ON \`payload_locked_documents_rels\` (\`tags_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_taggings_id_idx\` ON \`payload_locked_documents_rels\` (\`taggings_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_spaces_id_idx\` ON \`payload_locked_documents_rels\` (\`spaces_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_maintenance_requests_id_idx\` ON \`payload_locked_documents_rels\` (\`maintenance_requests_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_maintenance_work_orders_id_idx\` ON \`payload_locked_documents_rels\` (\`maintenance_work_orders_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_bookable_resources_id_idx\` ON \`payload_locked_documents_rels\` (\`bookable_resources_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_bookings_id_idx\` ON \`payload_locked_documents_rels\` (\`bookings_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_carriers_id_idx\` ON \`payload_locked_documents_rels\` (\`carriers_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_tracking_events_id_idx\` ON \`payload_locked_documents_rels\` (\`tracking_events_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_customs_declarations_id_idx\` ON \`payload_locked_documents_rels\` (\`customs_declarations_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_consignment_arrangements_i_idx\` ON \`payload_locked_documents_rels\` (\`consignment_arrangements_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_consignment_inventory_id_idx\` ON \`payload_locked_documents_rels\` (\`consignment_inventory_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_consignment_sales_id_idx\` ON \`payload_locked_documents_rels\` (\`consignment_sales_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_api_audit_events_id_idx\` ON \`payload_locked_documents_rels\` (\`api_audit_events_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_evidence_attestations_id_idx\` ON \`payload_locked_documents_rels\` (\`evidence_attestations_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_entity_types_id_idx\` ON \`payload_locked_documents_rels\` (\`entity_types_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_taxing_jurisdictions_id_idx\` ON \`payload_locked_documents_rels\` (\`taxing_jurisdictions_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_entity_legal_structures_id_idx\` ON \`payload_locked_documents_rels\` (\`entity_legal_structures_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_compliance_frameworks_id_idx\` ON \`payload_locked_documents_rels\` (\`compliance_frameworks_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_compliance_requirements_id_idx\` ON \`payload_locked_documents_rels\` (\`compliance_requirements_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_internal_controls_id_idx\` ON \`payload_locked_documents_rels\` (\`internal_controls_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_audit_samples_id_idx\` ON \`payload_locked_documents_rels\` (\`audit_samples_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_compliance_gaps_id_idx\` ON \`payload_locked_documents_rels\` (\`compliance_gaps_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_audit_evidence_id_idx\` ON \`payload_locked_documents_rels\` (\`audit_evidence_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_audit_trail_events_id_idx\` ON \`payload_locked_documents_rels\` (\`audit_trail_events_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_remediation_plans_id_idx\` ON \`payload_locked_documents_rels\` (\`remediation_plans_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_audit_committees_id_idx\` ON \`payload_locked_documents_rels\` (\`audit_committees_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_audit_committee_members_id_idx\` ON \`payload_locked_documents_rels\` (\`audit_committee_members_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_board_actions_id_idx\` ON \`payload_locked_documents_rels\` (\`board_actions_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_management_certifications__idx\` ON \`payload_locked_documents_rels\` (\`management_certifications_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_regulatory_reports_id_idx\` ON \`payload_locked_documents_rels\` (\`regulatory_reports_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_internal_policies_id_idx\` ON \`payload_locked_documents_rels\` (\`internal_policies_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_statutory_report_templates_idx\` ON \`payload_locked_documents_rels\` (\`statutory_report_templates_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_statutory_field_mappings_i_idx\` ON \`payload_locked_documents_rels\` (\`statutory_field_mappings_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_policy_versions_id_idx\` ON \`payload_locked_documents_rels\` (\`policy_versions_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_policy_acknowledgments_id_idx\` ON \`payload_locked_documents_rels\` (\`policy_acknowledgments_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_compliance_deadlines_id_idx\` ON \`payload_locked_documents_rels\` (\`compliance_deadlines_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_compliance_notifications_i_idx\` ON \`payload_locked_documents_rels\` (\`compliance_notifications_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_reporting_standards_id_idx\` ON \`payload_locked_documents_rels\` (\`reporting_standards_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_reporting_mappings_id_idx\` ON \`payload_locked_documents_rels\` (\`reporting_mappings_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_related_party_transactions_idx\` ON \`payload_locked_documents_rels\` (\`related_party_transactions_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_management_assessment_icfr_idx\` ON \`payload_locked_documents_rels\` (\`management_assessment_icfr_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_disclosure_checklists_id_idx\` ON \`payload_locked_documents_rels\` (\`disclosure_checklists_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_audit_committee_minutes_id_idx\` ON \`payload_locked_documents_rels\` (\`audit_committee_minutes_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_risk_register_id_idx\` ON \`payload_locked_documents_rels\` (\`risk_register_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_debt_schedule_id_idx\` ON \`payload_locked_documents_rels\` (\`debt_schedule_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_internal_audit_function_id_idx\` ON \`payload_locked_documents_rels\` (\`internal_audit_function_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_segment_reporting_id_idx\` ON \`payload_locked_documents_rels\` (\`segment_reporting_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_csrd_disclosures_id_idx\` ON \`payload_locked_documents_rels\` (\`csrd_disclosures_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_carbon_emissions_id_idx\` ON \`payload_locked_documents_rels\` (\`carbon_emissions_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_biological_assets_id_idx\` ON \`payload_locked_documents_rels\` (\`biological_assets_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_mineral_resource_assets_id_idx\` ON \`payload_locked_documents_rels\` (\`mineral_resource_assets_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_investment_properties_id_idx\` ON \`payload_locked_documents_rels\` (\`investment_properties_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_provisions_id_idx\` ON \`payload_locked_documents_rels\` (\`provisions_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_government_grants_id_idx\` ON \`payload_locked_documents_rels\` (\`government_grants_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_deferred_tax_items_id_idx\` ON \`payload_locked_documents_rels\` (\`deferred_tax_items_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_share_based_payments_id_idx\` ON \`payload_locked_documents_rels\` (\`share_based_payments_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_business_combinations_id_idx\` ON \`payload_locked_documents_rels\` (\`business_combinations_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_held_for_sale_classificati_idx\` ON \`payload_locked_documents_rels\` (\`held_for_sale_classifications_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_fair_value_measurements_id_idx\` ON \`payload_locked_documents_rels\` (\`fair_value_measurements_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_earnings_per_share_id_idx\` ON \`payload_locked_documents_rels\` (\`earnings_per_share_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_insurance_contracts_id_idx\` ON \`payload_locked_documents_rels\` (\`insurance_contracts_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_regulatory_deferral_accoun_idx\` ON \`payload_locked_documents_rels\` (\`regulatory_deferral_accounts_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_post_balance_sheet_events__idx\` ON \`payload_locked_documents_rels\` (\`post_balance_sheet_events_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_transaction_failures_id_idx\` ON \`payload_locked_documents_rels\` (\`transaction_failures_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_transfer_pricing_files_id_idx\` ON \`payload_locked_documents_rels\` (\`transfer_pricing_files_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_memories_id_idx\` ON \`payload_locked_documents_rels\` (\`memories_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_mcp_tool_metadata_id_idx\` ON \`payload_locked_documents_rels\` (\`mcp_tool_metadata_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_contract_amendments_id_idx\` ON \`payload_locked_documents_rels\` (\`contract_amendments_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_contract_performance_id_idx\` ON \`payload_locked_documents_rels\` (\`contract_performance_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_contract_signatures_id_idx\` ON \`payload_locked_documents_rels\` (\`contract_signatures_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_contract_templates_id_idx\` ON \`payload_locked_documents_rels\` (\`contract_templates_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_legal_entities_id_idx\` ON \`payload_locked_documents_rels\` (\`legal_entities_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_ai_suggestions_id_idx\` ON \`payload_locked_documents_rels\` (\`ai_suggestions_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_consolidations_id_idx\` ON \`payload_locked_documents_rels\` (\`consolidations_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_tax_periods_id_idx\` ON \`payload_locked_documents_rels\` (\`tax_periods_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_audit_reports_id_idx\` ON \`payload_locked_documents_rels\` (\`audit_reports_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_transfer_pricing_adjustmen_idx\` ON \`payload_locked_documents_rels\` (\`transfer_pricing_adjustments_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_post_close_analytics_repor_idx\` ON \`payload_locked_documents_rels\` (\`post_close_analytics_reports_id\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`taggings_rels\`;`)
