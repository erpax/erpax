...
/** Credit for claims in src/versions/cross/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/versions/cross/index.ts — leftover wave proof', () => {
