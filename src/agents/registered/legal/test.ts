 ...
 * `@/agents/registered/legal` simply stop seeing it, with no error anywhere. This folder was assembled
...
describe('agents/registered/legal — the barrel is the one face', () => {
