...
> atom `display` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `display`
- partition root `7975c75d-cd3f-8430-a2f3-99e51c124aa3`
- bond degree `13`
...
<sub>content-uuid `b0f8ead8-cab4-8bf4-99f7-3e534ec57db0` · framed by typography partition `display` bonds `13` · `pnpm readme` · `pnpm readme:check`</sub>
