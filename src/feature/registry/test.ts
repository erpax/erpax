...
/** Credit for claims in src/feature/registry/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/feature/registry/index.ts — leftover wave proof', () => {
