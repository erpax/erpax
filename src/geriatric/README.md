...
> atom `geriatric` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `geriatric`
- partition root `4dbf423d-de41-8e8d-8a16-71e2f4bf0530`
- bond degree `12`
...
<sub>content-uuid `f6cf9664-d0ee-8168-aa8b-a4ae5b0b2284` · framed by typography partition `geriatric` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
