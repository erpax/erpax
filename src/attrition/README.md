...
> atom `attrition` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `attrition`
- partition root `ab1c2865-26cc-811e-92e5-f20abef2a48e`
- bond degree `18`
...
<sub>content-uuid `fc2e9138-8543-8398-8651-7194af6bf7ca` · framed by typography partition `attrition` bonds `18` · `pnpm readme` · `pnpm readme:check`</sub>
