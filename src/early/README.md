...
> atom `early` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `early`
- partition root `cdbf2ea5-17d7-8c9e-ac73-b666fd078893`
- bond degree `16`
...
<sub>content-uuid `3534cf47-c67a-807e-abcd-7fab42d24691` · framed by typography partition `early` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
