...
> atom `practice` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `practice`
- partition root `7b88ee16-ea8f-8306-8165-bd29af7d99b9`
- bond degree `8`
...
<sub>content-uuid `e6f86cff-cd38-8024-ad66-056b66349c7a` · framed by typography partition `practice` bonds `8` · `pnpm readme` · `pnpm readme:check`</sub>
