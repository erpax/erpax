...
> atom `invite` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `invite`
- partition root `f6f27cf1-77fa-88d3-97e3-25f7352df29d`
- bond degree `20`
...
<sub>content-uuid `9bd7cb8c-88c7-8676-96f6-578417e5c047` · framed by typography partition `invite` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
