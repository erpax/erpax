...
/** Credit for claims in src/types/multi/currency/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/types/multi/currency/index.ts — leftover wave proof', () => {
