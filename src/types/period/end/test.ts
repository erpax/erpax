...
/** Credit for claims in src/types/period/end/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/types/period/end/index.ts — leftover wave proof', () => {
