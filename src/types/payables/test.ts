...
/** Credit for claims in src/types/payables/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/types/payables/index.ts — leftover wave proof', () => {
