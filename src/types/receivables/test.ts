...
/** Credit for claims in src/types/receivables/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/types/receivables/index.ts — leftover wave proof', () => {
