...
> atom `gene` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `gene`
- partition root `4d32f6ab-51f3-8f61-a510-45674d09b66e`
- bond degree `13`
...
<sub>content-uuid `5c95f54a-1a45-8b13-9cba-2297cf2b7782` · framed by typography partition `gene` bonds `13` · `pnpm readme` · `pnpm readme:check`</sub>
