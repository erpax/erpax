...
> atom `rsvp` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `rsvp`
- partition root `907fe590-952a-84dc-9e1b-e14781ac82c8`
- bond degree `16`
...
<sub>content-uuid `3fc6b028-36a4-8257-8cf5-91c008400524` · framed by typography partition `rsvp` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
