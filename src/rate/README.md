...
> atom `rate` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `rate`
- partition root `e877b856-8697-887e-bad9-d56eebc3852d`
- bond degree `57`
...
<sub>content-uuid `32389058-0b82-8cde-9a6c-107b6bcd1f4b` · framed by typography partition `rate` bonds `57` · `pnpm readme` · `pnpm readme:check`</sub>
