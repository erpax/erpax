...
> atom `beyond/bitemporal` · horo `—` `—` · [[balance]] `0` · [[seal]] `0`
...
<sub>content-uuid `a333c484-2d2f-8ded-9206-8791581f968d` · framed by typography partition `beyond` bonds `7` · `pnpm readme` · `pnpm readme:check`</sub>
