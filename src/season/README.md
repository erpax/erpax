...
> atom `season` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `season`
- partition root `9df00562-c211-8481-a0cb-105287b64a16`
- bond degree `50`
...
<sub>content-uuid `6cbcf1fa-884f-8168-a723-a3ced1f8dd7e` · framed by typography partition `season` bonds `50` · `pnpm readme` · `pnpm readme:check`</sub>
