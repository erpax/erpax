...
> atom `monetary` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `monetary`
- partition root `79830e1a-dd1d-803f-8367-f3158f08c499`
- bond degree `24`
...
<sub>content-uuid `e2abd160-8093-82bb-baad-87e6d8266526` · framed by typography partition `monetary` bonds `24` · `pnpm readme` · `pnpm readme:check`</sub>
