...
> atom `children` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `children`
- partition root `9c498b5b-7c61-88e1-a37b-abbaef4115ae`
- bond degree `11`
...
<sub>content-uuid `2d89998d-9e26-827f-9041-89794ebb716b` · framed by typography partition `children` bonds `11` · `pnpm readme` · `pnpm readme:check`</sub>
