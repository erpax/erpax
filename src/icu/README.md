...
> atom `icu` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `icu`
- partition root `272173f6-c72d-857d-a257-af9dbd5d9fe8`
- bond degree `20`
...
<sub>content-uuid `96cf4bb4-7133-80c5-8e5a-87aa2698014d` · framed by typography partition `icu` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
