...
> atom `property` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `property`
- partition root `fead4df5-57ff-82fd-87f5-5dca6f62be54`
- bond degree `20`
...
<sub>content-uuid `8d615c5e-abe5-8449-8631-f002d43933ee` · framed by typography partition `property` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
