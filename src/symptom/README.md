...
> atom `symptom` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `symptom`
- partition root `aee585c8-5807-80df-935d-dd925753d8fe`
- bond degree `16`
...
<sub>content-uuid `10be25a3-2932-805f-932c-ba688afba7ca` · framed by typography partition `symptom` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
