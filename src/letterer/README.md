...
> atom `letterer` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `letterer`
- partition root `8f255ce4-62ab-8711-a245-858acb6d89fa`
- bond degree `13`
...
<sub>content-uuid `5882cc85-7e4b-8517-9f2e-c1ce56384a6b` · framed by typography partition `letterer` bonds `13` · `pnpm readme` · `pnpm readme:check`</sub>
