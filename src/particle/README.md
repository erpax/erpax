...
> atom `particle` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `particle`
- partition root `4db7f4e0-2b20-8614-a3f7-57784975cb9f`
- bond degree `26`
...
<sub>content-uuid `aad55a25-02b2-833a-80f7-6871f2f6dc2b` · framed by typography partition `particle` bonds `26` · `pnpm readme` · `pnpm readme:check`</sub>
