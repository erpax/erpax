...
> atom `surgery` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `surgery`
- partition root `25c666cd-28ad-8f16-8db8-86181816f3d4`
- bond degree `8`
...
<sub>content-uuid `bbccb380-6add-8b6e-bf59-649c198d9e75` · framed by typography partition `surgery` bonds `8` · `pnpm readme` · `pnpm readme:check`</sub>
