...
> atom `award` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `award`
- partition root `09dcac1e-f891-82fe-88dc-9aece0aba2ea`
- bond degree `6`
...
<sub>content-uuid `df158980-2a7e-81cf-ab06-f8f1226cd469` · framed by typography partition `award` bonds `6` · `pnpm readme` · `pnpm readme:check`</sub>
