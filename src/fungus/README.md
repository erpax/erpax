...
> atom `fungus` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `fungus`
- partition root `ad00a97a-618b-8244-bc11-2d13a37784d7`
- bond degree `20`
...
<sub>content-uuid `17409924-344a-868e-9619-48acc87f99ec` · framed by typography partition `fungus` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
