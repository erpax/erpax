...
> atom `assign` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `assign`
- partition root `954023ec-067a-887e-8935-0783bd78c835`
- bond degree `16`
...
<sub>content-uuid `04f9bacd-acb2-8d13-8a10-c71561cb887b` · framed by typography partition `assign` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
