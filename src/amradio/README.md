...
> atom `amradio` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `amradio`
- partition root `92e6535b-6a97-890b-b19b-8b44b77bf38a`
- bond degree `12`
...
<sub>content-uuid `92f39239-687e-8d0b-ae62-0698c7585a1d` · framed by typography partition `amradio` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
