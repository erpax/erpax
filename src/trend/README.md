...
> atom `trend` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `trend`
- partition root `f8cc6818-fcab-8e77-ab5f-f06a85da4d3c`
- bond degree `18`
...
<sub>content-uuid `4e1ab552-18e3-8d91-ad34-302c5a21a97e` · framed by typography partition `trend` bonds `18` · `pnpm readme` · `pnpm readme:check`</sub>
