...
import { createAgentContext } from '@/services/agents/context'
...
export function buildErpaxMcpTools(registry: AgentRegistry): ErpaxMcpTool[] {
  ...
  // kept (adds 4-language i18n; consistency.proposeEmitterWiring keeps the
  // PascalCase emitter-name suggestion via toPascal). Neither takes the
  // registry. Conservation Law 38 mcp-tool-standardization.
