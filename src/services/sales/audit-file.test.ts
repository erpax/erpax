 ...
 * @see src/services/supto/audit-file.ts
 */

import { describe, it, expect } from 'vitest'
import { buildSuptoAuditReport, toSuptoAuditXml, type SuptoSaleInput } from './audit-file'

const SALES: SuptoSaleInput[] = [
  { unp: '12345678-0042-0000002', fiscalDeviceNumber: '12345678', operatorCode: '0042', saleDate: '2026-04-20T10:00:00Z', total: 1_200_00, currency: 'BGN', paymentType: 'card', status: 'closed', fiscalReceiptNumber: 'R-2' },
  ...
  { unp: '12345678-0042-0000003', fiscalDeviceNumber: '12345678', operatorCode: '0042', saleDate: '2026-04-21T11:00:00Z', total: -1_200_00, status: 'closed', reversalOf: '12345678-0042-0000002' },
]

describe('buildSuptoAuditReport', () => {
  const report = buildSuptoAuditReport({ sales: SALES, periodStart: '2026-04-01', periodEnd: '2026-04-30', tenantEik: '123456789' })
...
describe('toSuptoAuditXml', () => {
  ...
  it('emits one <Sale> per row carrying the УНП', () => {
