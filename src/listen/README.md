...
> atom `listen` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `listen`
- partition root `f3b61f78-43cc-8827-85b1-7b82b0eafe30`
- bond degree `13`
...
<sub>content-uuid `0ee86d54-489d-8b44-ab89-e6e229205479` · framed by typography partition `listen` bonds `13` · `pnpm readme` · `pnpm readme:check`</sub>
