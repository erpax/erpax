...
> atom `ski` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `ski`
- partition root `8aa63b81-864e-84f9-be87-a50c5060d373`
- bond degree `14`
...
<sub>content-uuid `e82f1b34-ce2f-8ab0-8197-55c70f8785b1` · framed by typography partition `ski` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
