...
> atom `parody` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `parody`
- partition root `38197a81-e8bb-8d29-bae6-52b10cbf663c`
- bond degree `12`
...
<sub>content-uuid `507f8595-0fee-8ee9-af1f-9e514b4af730` · framed by typography partition `parody` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
