...
> atom `oncologic` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `oncologic`
- partition root `592ff385-dc92-84ab-95b5-313591c1f75a`
- bond degree `18`
...
<sub>content-uuid `b88d74f9-e2c3-8099-802c-b6d1865cfdd4` · framed by typography partition `oncologic` bonds `18` · `pnpm readme` · `pnpm readme:check`</sub>
