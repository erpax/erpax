...
> atom `slogan` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `slogan`
- partition root `b9975c82-20e7-8fdf-bc40-300682330631`
- bond degree `14`
...
<sub>content-uuid `40583b74-ebe7-8ac9-9421-a845a677ab0c` · framed by typography partition `slogan` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
