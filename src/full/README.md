...
> atom `full` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `full`
- partition root `1e0ec79d-4b3f-82b0-9776-9f63adf0f5ba`
- bond degree `17`
...
<sub>content-uuid `6a406877-cd48-8b1d-b0c3-f17439c811ce` · framed by typography partition `full` bonds `17` · `pnpm readme` · `pnpm readme:check`</sub>
