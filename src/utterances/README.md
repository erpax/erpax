...
> atom `utterances` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition root `2baf5bb1-5f58-8470-8759-b67aa1baa086`
- bond degree `7`
...
<sub>content-uuid `24d63e24-50d2-8f04-9f55-4afecb14be54` · framed by typography partition `utterances` bonds `7` · `pnpm readme` · `pnpm readme:check`</sub>
