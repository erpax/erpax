...
> atom `museum` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `museum`
- partition root `d65e553b-7cc5-8431-97d9-367fc916e3b3`
- bond degree `6`
...
<sub>content-uuid `ccc77c08-95a5-8f40-aa0f-4e08d57e4179` · framed by typography partition `museum` bonds `6` · `pnpm readme` · `pnpm readme:check`</sub>
