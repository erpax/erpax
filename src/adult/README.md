...
> atom `adult` · horo `4` `weave` · [[balance]] `1` · [[seal]] `1`

## [[debit]] · [[credit]]

> account code `adult` · currency `eb` (entropy-bit)
...
- partition `adult` · sub-root `4da3ae26-149e-8b6e-9da3-6c8af5a12d98`
...
<sub>content-uuid `c559c766-c4e9-8b9b-b6f0-851de3f0bf09` · framed by typography partition `adult` bonds `32` · `pnpm readme` · `pnpm readme:check`</sub>
