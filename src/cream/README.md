...
> atom `cream` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `cream`
- partition root `d61b57eb-a301-83e1-95e4-e3a5cc3a5504`
- bond degree `20`
...
<sub>content-uuid `b20e7460-1821-857d-b71d-991ea6672b45` · framed by typography partition `cream` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
