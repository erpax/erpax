...
> atom `impaired` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `impaired`
- partition root `e0cfb2a9-1cb3-8034-8194-86e7cf4e96b7`
- bond degree `14`
...
<sub>content-uuid `beac9ed3-4da6-8592-a8b8-ebdff7680b32` · framed by typography partition `impaired` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
