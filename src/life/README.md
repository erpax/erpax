...
> atom `life` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `life`
- partition root `134baa70-fed0-880a-bbec-454c8121c04a`
- bond degree `9`
...
<sub>content-uuid `b4405496-fde6-8b79-8143-fd4633f7e085` · framed by typography partition `life` bonds `9` · `pnpm readme` · `pnpm readme:check`</sub>
