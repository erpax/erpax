...
> atom `wear` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `wear`
- partition root `c451e494-e74c-8653-8b34-a91f49287dc2`
- bond degree `13`
...
<sub>content-uuid `0bb8c10f-06d7-844f-b392-0a2193169265` · framed by typography partition `wear` bonds `13` · `pnpm readme` · `pnpm readme:check`</sub>
