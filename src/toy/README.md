...
> atom `toy` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `toy`
- partition root `14144490-67dd-8b99-a6ba-a3a9697e3f43`
- bond degree `18`
...
<sub>content-uuid `3bdab7e0-88eb-8e2d-bf08-ad42e346e405` · framed by typography partition `toy` bonds `18` · `pnpm readme` · `pnpm readme:check`</sub>
