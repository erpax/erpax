...
/** Credit for claims in src/svg/hero/generator/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/svg/hero/generator/index.ts — leftover wave proof', () => {
