...
> atom `polygon` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `polygon`
- partition root `2cdc62b4-8344-8173-898c-75bc3d8da1cb`
- bond degree `12`
...
<sub>content-uuid `27453f97-d79b-8e65-947c-fd6eb3de3894` · framed by typography partition `polygon` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
