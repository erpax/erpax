...
> atom `official` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `official`
- partition root `0f6ada35-4911-8dc7-966c-620c867e5abd`
- bond degree `16`
...
<sub>content-uuid `2c164f8b-aaf6-849c-bffe-adae406c93c4` · framed by typography partition `official` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
