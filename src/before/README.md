...
> atom `before` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `before`
- partition root `c4d44480-de75-8d94-b65b-bf9633b1befb`
- bond degree `16`
...
<sub>content-uuid `57640173-fa18-8e54-99e6-6a68c98fddd8` · framed by typography partition `before` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
