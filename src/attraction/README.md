...
> atom `attraction` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition root `210cac67-e232-8ece-97f0-9e7d343d203c`
- bond degree `20`
...
<sub>content-uuid `505d322d-0959-863a-a5fa-c1beebc9c1bc` · framed by typography partition `attraction` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
