...
> atom `sexual` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `sexual`
- partition root `928cf7bb-e2cf-81aa-98ef-32e630bdca3d`
- bond degree `18`
...
<sub>content-uuid `07bebc95-0e93-8ee6-8e0a-2079e8c58844` · framed by typography partition `sexual` bonds `18` · `pnpm readme` · `pnpm readme:check`</sub>
