...
> atom `mechanism` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `mechanism`
- partition root `110cd494-6200-8645-919c-168f35286774`
- bond degree `15`
...
<sub>content-uuid `68881ac8-497a-8264-8e6e-2a50ce09c297` · framed by typography partition `mechanism` bonds `15` · `pnpm readme` · `pnpm readme:check`</sub>
