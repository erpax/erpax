...
> atom `equity` · horo `—` `—` · [[balance]] `1` · [[seal]] `0`
...
<sub>content-uuid `b60f013a-aa0c-805b-8c3a-eaabccbabfe6` · framed by typography partition `equity` bonds `9` · `pnpm readme` · `pnpm readme:check`</sub>
