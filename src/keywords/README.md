...
> atom `keywords` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `keywords`
- partition root `8128c75c-cd39-8c37-a106-c0f141433027`
- bond degree `14`
...
<sub>content-uuid `c9298ba4-e08d-8fd3-8720-b508659d0b2d` · framed by typography partition `keywords` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
