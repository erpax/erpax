...
- **check** (the law · matter) — STRICT: every violation a hard FAIL, never a warn ([[standard]] · [[architecture-invariants]]). Green means *"obeys the law"*, not *"compiles"*. Tighter each pass.
