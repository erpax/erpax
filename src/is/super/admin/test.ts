...
/** Credit for claims in src/is/super/admin/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/is/super/admin/index.ts — leftover wave proof', () => {
