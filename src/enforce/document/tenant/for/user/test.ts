...
/** Credit for claims in src/enforce/document/tenant/for/user/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/enforce/document/tenant/for/user/index.ts — leftover wave proof', () => {
