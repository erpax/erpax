...
> atom `operators` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `operators`
- partition root `1bc6e7f1-4626-8fdd-8d5a-84e8d8a7dbee`
- bond degree `10`
...
<sub>content-uuid `39c83403-54f5-8e4a-8106-4dd228e803db` · framed by typography partition `operators` bonds `10` · `pnpm readme` · `pnpm readme:check`</sub>
