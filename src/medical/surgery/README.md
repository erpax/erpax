...
> atom `medical/surgery` · horo `1` `base` · [[balance]] `1` · [[seal]] `1`

## [[debit]] · [[credit]]

> account code `medical/surgery` · currency `eb` (entropy-bit)
...
- entry uuids `b126e417-c807-8ce4-9413-acae05503914`
- content uuids `adca16dd-e2fc-8ee0-a4d6-15c597c57347` · `c2f2f163-d1b6-8aaa-99ea-1746d3c2b331`
...
- uuid `adca16dd-e2fc-8ee0-a4d6-15c597c57347`
- bonds in `5` · out `5`
...
<sub>content-uuid `833586bb-4e74-8a52-b750-d4e36a4b2369` · framed by typography partition `medical` bonds `19` · `pnpm readme` · `pnpm readme:check`</sub>
