...
> atom `left` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `left`
- partition root `57198c40-5ac3-8ce0-a0b8-95a32fc729dd`
- bond degree `20`
...
<sub>content-uuid `90ccc751-4180-8bfb-b011-91019eaa1992` · framed by typography partition `left` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
