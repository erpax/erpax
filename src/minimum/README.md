...
> atom `minimum` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `minimum`
- partition root `20f0f589-5c23-8201-8166-6bd2ea422c48`
- bond degree `23`
...
<sub>content-uuid `d12d23e1-7ec0-8d80-bf6d-90031ea1390a` · framed by typography partition `minimum` bonds `23` · `pnpm readme` · `pnpm readme:check`</sub>
