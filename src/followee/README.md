...
> atom `followee` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `followee`
- partition root `13662a39-f386-8695-9b72-34416fee0a2b`
- bond degree `10`
...
<sub>content-uuid `2cae9543-4e8a-8708-9581-3c6f35bbcd94` · framed by typography partition `followee` bonds `10` · `pnpm readme` · `pnpm readme:check`</sub>
