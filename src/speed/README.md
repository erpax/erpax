...
> atom `speed` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `speed`
- partition root `b57c2655-41d2-849b-970e-259bddd96739`
- bond degree `27`
...
<sub>content-uuid `4b7ff757-2e9e-8416-b89f-40c5828affcf` · framed by typography partition `speed` bonds `27` · `pnpm readme` · `pnpm readme:check`</sub>
