...
> atom `extent` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `extent`
- partition root `9cccacd1-d699-8492-9e21-78eec9e74314`
- bond degree `20`
...
<sub>content-uuid `d238995c-7f02-87ba-834f-f3fc68517c50` · framed by typography partition `extent` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
