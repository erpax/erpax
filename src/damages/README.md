...
> atom `damages` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `damages`
- partition root `92bec025-ab35-8ed8-8c9e-38bad155af85`
- bond degree `16`
...
<sub>content-uuid `d53b18a2-ba3c-8598-b610-421e2724f8ba` · framed by typography partition `damages` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
