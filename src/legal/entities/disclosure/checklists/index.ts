/**
 * Disclosure Checklists — single-folder collection node.
 *
 * @accounting IFRS IAS-1 disclosure-requirements
 * @standard SEC Regulation S-K disclosure
 * @audit ISO-19011:2018 completeness
