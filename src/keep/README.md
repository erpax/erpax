...
> atom `keep` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `keep`
- partition root `51a76e66-7f06-8509-9345-0d2f8d85aa9f`
- bond degree `10`
...
<sub>content-uuid `161ff339-c34a-8953-b719-3a59e990ce61` · framed by typography partition `keep` bonds `10` · `pnpm readme` · `pnpm readme:check`</sub>
