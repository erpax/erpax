...
> atom `adjustment` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition root `5c943e2c-4f20-8d26-b13e-6a14d8f2ff30`
- bond degree `12`
...
<sub>content-uuid `5ee04fa0-a1a8-8ca8-8c11-022657fb68f2` · framed by typography partition `adjustment` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
