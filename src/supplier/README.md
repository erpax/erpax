...
> atom `supplier` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `supplier`
- partition root `11f966a6-86bd-8ec8-ad14-8457bc79d8c5`
- bond degree `16`
...
<sub>content-uuid `d6e1a513-8350-8ca8-9181-642d507e746b` · framed by typography partition `supplier` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
