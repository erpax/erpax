...
> atom `mobility` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `mobility`
- partition root `e345ae17-8589-8e0c-8d2c-0be4fd302ede`
- bond degree `26`
...
<sub>content-uuid `0036ebb4-ff34-86a8-bea5-be9439462d54` · framed by typography partition `mobility` bonds `26` · `pnpm readme` · `pnpm readme:check`</sub>
