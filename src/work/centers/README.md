...
> atom `work/centers` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
<sub>content-uuid `e3740626-cc4c-8902-8771-86156d2a3b8e` · framed by typography partition `work` bonds `38` · `pnpm readme` · `pnpm readme:check`</sub>
