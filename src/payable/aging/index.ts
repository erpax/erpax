/** @index-cross.foldback child=payable/aging parent=payable — this cross folds back into its parent. */
/**
 * A/P Aging Calculator — payables-side wrapper over `@/party/aging`.
 *
