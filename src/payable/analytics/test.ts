...
import * as analytics from '@/payable/analytics'

describe('payable/analytics — the child atom, reachable through its own address', () => {
  it('offers matter through @/payable/analytics, not only through the parent barrel', () => {
