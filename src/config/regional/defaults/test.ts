...
/** Credit for claims in src/config/regional/defaults/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/config/regional/defaults/index.ts — leftover wave proof', () => {
