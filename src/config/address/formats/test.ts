...
/** Credit for claims in src/config/address/formats/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/config/address/formats/index.ts — leftover wave proof', () => {
