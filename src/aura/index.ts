 ...
 *
 * Frontmatter FIRST is load-bearing: one unpaired backtick there pairs with the body's first and
 * eats the span between, links included — 1,920 edges lost in the collider's copy of this function.
 */
