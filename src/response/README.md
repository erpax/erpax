...
> atom `response` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `response`
- partition root `922bca2d-c335-846a-96bc-71ce3c46ec92`
- bond degree `13`
...
<sub>content-uuid `588a7745-2284-81cc-b483-04bf00d37666` · framed by typography partition `response` bonds `13` · `pnpm readme` · `pnpm readme:check`</sub>
