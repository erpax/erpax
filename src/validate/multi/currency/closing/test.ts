...
/** Credit for claims in src/validate/multi/currency/closing/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/validate/multi/currency/closing/index.ts — leftover wave proof', () => {
