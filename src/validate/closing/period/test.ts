...
/** Credit for claims in src/validate/closing/period/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/validate/closing/period/index.ts — leftover wave proof', () => {
