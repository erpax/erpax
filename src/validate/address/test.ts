...
/** Credit for claims in src/validate/address/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/validate/address/index.ts — leftover wave proof', () => {
