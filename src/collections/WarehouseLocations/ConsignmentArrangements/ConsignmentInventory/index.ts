...
import { currencyField, statusField, notesField, auditFields, unitOfMeasureField } from '../../../../fields/base-accounting-fields'
...
const ConsignmentInventory: CollectionConfig = {
  ...
  fields: [
    ...
    unitOfMeasureField({ description: 'UN/CEFACT Rec 20 unit-of-measure code (e.g. C62, KGM, LTR).' }),
  ...
  hooks: standardCollectionHooks('consignment-inventory'),
  timestamps: true,
}
