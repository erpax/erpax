...
import { emitOpRunCompleted } from '../hooks/chainEventEmitters'
...
const OperationRuns: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'unitOfMeasure', type: 'text', defaultValue: 'pcs',
      admin: { description: 'UoM of the quantities (pcs/kg/L/m…) — discrete and process.' } },
    {
      name: 'variants',
      type: 'array',
  ...
  hooks: {
    ...
    afterChange: [emitOpRunCompleted, auditTrailAfterChange('operation-runs')],
  },
  timestamps: true,
}
