...
const MaintenanceRequests: CollectionConfig = {
  ...
  hooks: standardCollectionHooks('maintenance-requests', { beforeChange: [autoSetTimestamp('triagedAt', (d) => (d as { status?: string }).status === 'triaged'), autoSetTimestamp('closedAt', (d) => {
