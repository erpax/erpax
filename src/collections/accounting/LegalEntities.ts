...
import { multiTenancyField, currencyField, statusField, notesField, auditFields, referenceField, countryCodeField, naceCodeField } from '@/fields/accounting/base-accounting-fields'
...
const LegalEntities: CollectionConfig = {
  ...
  hooks: {
    ...
    afterChange: [auditTrailAfterChange('legal-entities')],
  },
  timestamps: true,
}
