...
> atom `manuscript` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition root `5738bc47-e5bc-8ffc-a383-3959ec106b2a`
- bond degree `12`
...
<sub>content-uuid `fe7e4329-ac43-8e16-a9df-a53072e1588f` · framed by typography partition `manuscript` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
