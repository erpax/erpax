...
> atom `regular` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `regular`
- partition root `852de4e0-caff-8b1c-96a3-b687cc396c56`
- bond degree `16`
...
<sub>content-uuid `cbc5a03f-6fb1-8f01-913f-a483c80bb9de` · framed by typography partition `regular` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
