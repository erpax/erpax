...
> atom `gynecologic` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition root `ee9742f1-a4d7-8d6e-ba57-2d861b2e9cb4`
- bond degree `12`
...
<sub>content-uuid `3e597ac1-2494-8386-868f-f3782fc99f64` · framed by typography partition `gynecologic` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
