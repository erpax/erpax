...
> atom `operating` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `operating`
- partition root `c5a28633-31a7-8787-bdd9-94653ee9321d`
- bond degree `10`
...
<sub>content-uuid `be8682af-f803-89da-a1c1-e607b4af2079` · framed by typography partition `operating` bonds `10` · `pnpm readme` · `pnpm readme:check`</sub>
