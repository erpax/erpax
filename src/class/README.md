...
> atom `class` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `class`
- partition root `1debef4f-1c02-8493-a0dc-a5843ff8f8c3`
- bond degree `20`
...
<sub>content-uuid `18a15caf-ec00-87c1-9276-e1ac20e90fbb` · framed by typography partition `class` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
