...
> atom `reportage` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `reportage`
- partition root `a50fc365-b316-8f42-905c-2f2d02449a4f`
- bond degree `16`
...
<sub>content-uuid `2fbfc82b-6172-8dca-8fb4-7e858a8bc874` · framed by typography partition `reportage` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
