...
import { statusField, notesField, auditFields, referenceField, legalEntityField, taxonomySelect } from '@/base/accounting/field'
import {
  GHG_SCOPE_OPTIONS,
...
const CarbonEmissions: CollectionConfig = {
  ...
  hooks: standardCollectionHooks('carbon-emissions'),
  timestamps: true,
}
