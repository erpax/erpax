...
> atom `fiscal/periods/earnings/per/shares` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
<sub>content-uuid `c8b54897-cdf6-8141-b5c8-a0303d189dbe` · framed by typography partition `fiscal` bonds `15` · `pnpm readme` · `pnpm readme:check`</sub>
