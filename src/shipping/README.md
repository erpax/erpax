...
> atom `shipping` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `shipping`
- partition root `6dd477fd-f372-868b-967c-08efb0ab10e9`
- bond degree `51`
...
<sub>content-uuid `775fe392-48e2-8ba5-8d64-3ca05d338e84` · framed by typography partition `shipping` bonds `51` · `pnpm readme` · `pnpm readme:check`</sub>
