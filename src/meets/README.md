...
> atom `meets` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `meets`
- partition root `5e76df75-93ab-81b2-8dc9-d5059215dd9e`
- bond degree `14`
...
<sub>content-uuid `83a767b8-fff4-8f51-a22f-780e60df95fe` · framed by typography partition `meets` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
