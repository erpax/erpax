...
> atom `gtin12` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `gtin12`
- partition root `4165c191-5d20-8f7d-aecb-2ecd2836b97d`
- bond degree `12`
...
<sub>content-uuid `1541c0e3-f1d7-8c5c-bbec-80f539918612` · framed by typography partition `gtin12` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
