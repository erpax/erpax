...
> atom `fund` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `fund`
- partition root `0bfbd06e-cf2c-8a42-b3f4-ad77ac6a8d34`
- bond degree `14`
...
<sub>content-uuid `ccd2ceac-697f-8701-9ddc-ff8c0941709e` · framed by typography partition `fund` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
