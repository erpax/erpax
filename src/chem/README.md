...
> atom `chem` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `chem`
- partition root `9fce621d-459f-8248-8464-fc9e9c489672`
- bond degree `27`
...
<sub>content-uuid `18fbeada-128b-806f-a6ed-eacc4c7c2ebd` · framed by typography partition `chem` bonds `27` · `pnpm readme` · `pnpm readme:check`</sub>
