...
> atom `ear` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `ear`
- partition root `5d58a60d-e70b-83b0-88ab-d5e3c2e53a85`
- bond degree `14`
...
<sub>content-uuid `f393b1f9-9a48-8f0e-9f38-4454edfa1e82` · framed by typography partition `ear` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
