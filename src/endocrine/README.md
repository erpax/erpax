...
> atom `endocrine` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `endocrine`
- partition root `754c79b9-f304-8632-800b-5421cc280807`
- bond degree `16`
...
<sub>content-uuid `2dfd2812-e741-80ea-98ae-9eca1cd62ec6` · framed by typography partition `endocrine` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
