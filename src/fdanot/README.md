...
> atom `fdanot` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `fdanot`
- partition root `2267c877-b1e7-8aff-acf6-76194f7cfa58`
- bond degree `14`
...
<sub>content-uuid `71140363-4762-8537-b2c0-73c0f2ea7dec` · framed by typography partition `fdanot` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
