...
> atom `water` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `water`
- partition root `758772df-1aba-8a1f-ae24-e7d26ff924af`
- bond degree `20`
...
<sub>content-uuid `945d5dae-c47e-872b-8c9d-a0c2582e4218` · framed by typography partition `water` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
