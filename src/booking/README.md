...
> atom `booking` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `booking`
- partition root `e1778417-9ecd-8679-9ccc-79eabab26480`
- bond degree `18`
...
<sub>content-uuid `1802d4e7-db5d-82b0-8326-ffa4e16254b9` · framed by typography partition `booking` bonds `18` · `pnpm readme` · `pnpm readme:check`</sub>
