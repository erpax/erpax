...
import { referenceField, statusField, auditFields, notesField, currencyField } from '@/base/accounting/field'
import { emitShiftApproved } from '@/chain/event/emitter'
...
const WorkShifts: CollectionConfig = {
  ...
  hooks: standardCollectionHooks('work-shifts', { beforeChange: [computeWage], afterChange: [emitShiftApproved] }),
  timestamps: true,
}
