...
> atom `self/accounting` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
<sub>content-uuid `751fb42a-d316-81cf-beff-696fd962c829` · framed by typography partition `self` bonds `734` · `pnpm readme` · `pnpm readme:check`</sub>
