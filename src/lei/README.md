...
> atom `lei` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `lei`
- partition root `834832ea-510a-8ab2-ba26-afb20e97f548`
- bond degree `29`
...
<sub>content-uuid `b378bbbf-d9a5-8472-af1e-484343f8e530` · framed by typography partition `lei` bonds `29` · `pnpm readme` · `pnpm readme:check`</sub>
