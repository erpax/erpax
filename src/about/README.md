...
> atom `about` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `about`
- partition root `bcce305e-e515-8cae-bfa2-5baeda4c3f31`
- bond degree `15`
...
<sub>content-uuid `6e501e90-79ad-840f-93b8-8e76ebb56caa` · framed by typography partition `about` bonds `15` · `pnpm readme` · `pnpm readme:check`</sub>
