...
> atom `lose` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `lose`
- partition root `7f301bd9-fecd-8ba8-b8e7-bfeed927a5a1`
- bond degree `13`
...
<sub>content-uuid `90f645b9-0f8d-8992-8430-a0bcedba63f0` · framed by typography partition `lose` bonds `13` · `pnpm readme` · `pnpm readme:check`</sub>
