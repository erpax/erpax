...
> atom `vegetarian` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `vegetarian`
- partition root `4a05d419-944b-8b40-9179-f559fe1419ee`
- bond degree `20`
...
<sub>content-uuid `bb85904b-ba76-805b-9866-ca6931495fcd` · framed by typography partition `vegetarian` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
