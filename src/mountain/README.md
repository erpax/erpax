...
> atom `mountain` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `mountain`
- partition root `5d4077c2-575b-8d9c-81d4-ea82077f4520`
- bond degree `10`
...
<sub>content-uuid `7c2eee77-dd34-8e95-a72c-be2d5de1bf7a` · framed by typography partition `mountain` bonds `10` · `pnpm readme` · `pnpm readme:check`</sub>
