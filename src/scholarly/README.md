...
> atom `scholarly` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `scholarly`
- partition root `13083889-652b-8a30-8c38-7898fe3250ee`
- bond degree `20`
...
<sub>content-uuid `5f2bff30-ce67-8d51-8d99-e48f39d0c394` · framed by typography partition `scholarly` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
