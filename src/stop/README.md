...
> atom `stop` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `stop`
- partition root `659b5521-313d-8634-a385-205d96698c3e`
- bond degree `18`
...
<sub>content-uuid `068213f9-ca89-834e-9c38-bf01dd86a397` · framed by typography partition `stop` bonds `18` · `pnpm readme` · `pnpm readme:check`</sub>
