...
> atom `odometer` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `odometer`
- partition root `973de0a1-0692-86ba-ac94-642c2e4540d1`
- bond degree `14`
...
<sub>content-uuid `78824dd9-e654-8bbc-8571-e7c024840fb6` · framed by typography partition `odometer` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
