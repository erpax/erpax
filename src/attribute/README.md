...
> atom `attribute` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `attribute`
- partition root `58e4a910-cd46-844b-9fc0-f0d9044cd163`
- bond degree `16`
...
<sub>content-uuid `758c11d7-4754-860c-af80-5d3180065948` · framed by typography partition `attribute` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
