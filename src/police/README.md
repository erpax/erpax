...
> atom `police` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `police`
- partition root `dd4567b4-ff54-8f34-a888-974e5a53c590`
- bond degree `20`
...
<sub>content-uuid `af9c7dd6-1a19-8343-8276-44b6447ffab6` · framed by typography partition `police` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
