...
> atom `force` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `force`
- partition root `8ff753f5-a1bf-8aa6-99d2-6c7282a72137`
- bond degree `39`
...
<sub>content-uuid `1691fab5-5f2a-8d9f-82e6-4635d7361f79` · framed by typography partition `force` bonds `39` · `pnpm readme` · `pnpm readme:check`</sub>
