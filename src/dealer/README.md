...
> atom `dealer` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `dealer`
- partition root `46f64c70-94d8-839a-a55e-20bb1c44ffb1`
- bond degree `16`
...
<sub>content-uuid `7f090798-fedb-8375-b4b3-4212c111bc88` · framed by typography partition `dealer` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
