...
atomPath: algebra
coordinate: "algebra · 5/round · 76209460"
contentUuid: "6860c5fb-99c3-52a5-8bcc-4de7cfe8a1c3"
diamondUuid: "de8ee494-bb0c-84d6-8d6a-08b2d2e3be5a"
...
bindings: []
signatures:
  computationUuid: "ab2e1788-b390-832a-a19a-93b263bce04c"
  stages:
    - stage: path
    ...
    - stage: horo
      stageUuid: "19b16559-e5fe-84b1-924c-56a10fefadf0"
    - stage: seal
      stageUuid: "0f350592-32ce-8e8e-b1be-312b6ecd6d66"
    - stage: uuid
      stageUuid: "5a778ce4-6d07-8b73-8f62-f5c1f5acd4f7"
version: 2
---
...
**Honest boundary.** "All theorems are algebra only" is shown for THIS session's theorems — each reduces to a closed operation on a set, tested. It does not prove every conceivable theorem is algebra (a claim about all of mathematics). And the base is still assumed ([[theorem]]: `s > 0`) — the carriers and their closure rest on axioms this atom marks, never proves.
