...
> atom `tuesday` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `tuesday`
- partition root `6b266685-b3ab-819c-99f7-2ef9371ef68f`
- bond degree `16`
...
<sub>content-uuid `d775057d-a52f-8865-ad61-db33fa53dffd` · framed by typography partition `tuesday` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
