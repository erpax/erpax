...
> atom `synagogue` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `synagogue`
- partition root `79dc06ec-cde9-8fc1-b6e1-a33c5bca048a`
- bond degree `10`
...
<sub>content-uuid `0d9decfc-17c1-8c56-9c79-2585591a945e` · framed by typography partition `synagogue` bonds `10` · `pnpm readme` · `pnpm readme:check`</sub>
