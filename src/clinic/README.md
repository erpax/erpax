...
> atom `clinic` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `clinic`
- partition root `8501af6c-e673-8e5a-8fa4-7d6cc4c665e3`
- bond degree `14`
...
<sub>content-uuid `d954b569-cd58-85a3-8147-26b7b89e4b22` · framed by typography partition `clinic` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
