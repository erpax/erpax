...
> atom `installment` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition root `622a4515-1c75-8317-864a-0a12343feaa4`
- bond degree `8`
...
<sub>content-uuid `aa114cdc-d3e8-8b2f-a644-de67d624a027` · framed by typography partition `installment` bonds `8` · `pnpm readme` · `pnpm readme:check`</sub>
