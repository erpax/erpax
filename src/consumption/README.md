...
> atom `consumption` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition root `740291a7-9381-8bb6-8649-4185d461764f`
- bond degree `22`
...
<sub>content-uuid `f193137e-c54d-8b6a-a59a-2417f6c081de` · framed by typography partition `consumption` bonds `22` · `pnpm readme` · `pnpm readme:check`</sub>
