...
/** Credit for claims in src/period/end/adjustment/service/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/period/end/adjustment/service/index.ts — leftover wave proof', () => {
