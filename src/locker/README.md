...
> atom `locker` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `locker`
- partition root `6ecd612d-bd44-8b20-8afa-233438c66127`
- bond degree `12`
...
<sub>content-uuid `1278a331-304c-8515-805d-0127a999c4f7` · framed by typography partition `locker` bonds `12` · `pnpm readme` · `pnpm readme:check`</sub>
