...
coordinate: "vocabulary/begin · 7/descent · 5935ebe5"
contentUuid: "89deda0b-6f4e-5546-b095-ba0a12111669"
diamondUuid: "ef0dd1b9-2df3-8438-8e3f-3c61559fc2fd"
...
bindings: []
signatures:
  computationUuid: "a643b6f1-2950-8749-8f87-809e2d8e86f0"
  stages:
    - stage: path
    ...
    - stage: horo
      stageUuid: "b5233e5e-3d24-882e-a09c-f2a45518cfc9"
    - stage: seal
      stageUuid: "e441617b-580b-875a-8fc1-7368a40d8af1"
    - stage: uuid
      stageUuid: "95cf59b6-cc0d-8a1f-b2c0-210e2a24901b"
version: 2
---
# begin — origin (the 0 is both end and beginning)

`begin` is the universal root of **origin**. The `0` is both end and beginning — every pass of the [[sequence]] departs from and returns to it ([[config]] + [[identity]]); fiscal periods open and close ([[accounting]]); a lifecycle starts and seals (freeze-on-seal [[identity]]; draft → posted [[versions]]). End is begin one dimension up — the wave returns to a new `0`. The dual: end.
