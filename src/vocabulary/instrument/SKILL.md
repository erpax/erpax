...
Attested in schema.org — instrument

**Law — [[law]]: instrument is one schema.org word, content-addressed; the same word collides every schema.org term that contains it into one atom, deduped, never duplicated.**
