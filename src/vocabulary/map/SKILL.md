...
Entangled with — [[category]] · [[type]] · [[has]]

Attested in schema.org — Map · MapCategoryType · hasMap · map · mapType

**Law — [[law]]: map is one schema.org word, content-addressed; the same word collides every schema.org term that contains it into one atom, deduped, never duplicated.**
