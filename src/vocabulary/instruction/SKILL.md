...
A directive step to be carried out. The singular model whose plural store is the [[instructions]] collection ([[balance]]: every collection has its model).

Composes [[instructions]] · [[document]] · [[balance]].

**Law — [[law]]: one instruction is the singular model of the [[instructions]] plural store — a directive step to be carried out; every collection has exactly its model ([[balance]]).**
