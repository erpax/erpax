...
Entangled with — [[individual]]

Attested in schema.org — IndividualPhysician · Physician

**Law — [[law]]: physician is one schema.org word, content-addressed; the same word collides every schema.org term that contains it into one atom, deduped, never duplicated.**
