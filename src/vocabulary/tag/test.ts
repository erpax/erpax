...
/** Credit for claims in src/vocabulary/tag/field.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/vocabulary/tag/field.ts — leftover wave proof', () => {
