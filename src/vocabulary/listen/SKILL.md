...
A schema.org component word, collided out of schema.org compounds — fused from ListenAction ([[sti]] · [[collapse]] · [[merge]]).

Entangled with — [[action]]

Attested in schema.org — ListenAction

**Law — [[law]]: listen is one schema.org word, content-addressed; the same word collides every schema.org term that contains it into one atom, deduped, never duplicated.**
