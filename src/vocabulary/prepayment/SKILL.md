...
Entangled with — [[early]] · [[penalty]]

Attested in schema.org — earlyPrepaymentPenalty

**Law — [[law]]: prepayment is one schema.org word, content-addressed; the same word collides every schema.org term that contains it into one atom, deduped, never duplicated.**
