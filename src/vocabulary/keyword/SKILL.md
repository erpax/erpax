...
A salient term used to index or retrieve content. The singular model whose plural store is the [[keywords]] collection ([[balance]]: every collection has its model).

**Law — [[law]]: the singular model of one [[keywords]] row — a salient term used to index or retrieve content; every collection has its model ([[balance]]).**

Composes [[keywords]] · [[content]] · [[balance]].
