...
Entangled with — [[affiliation]]

Attested in schema.org — Hospital · hospitalAffiliation

**Law — [[law]]: hospital is one schema.org word, content-addressed; the same word collides every schema.org term that contains it into one atom, deduped, never duplicated.**
