...
> atom `past` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `past`
- partition root `2ddac16d-7e7d-8946-ad2a-a297f5cc1940`
- bond degree `16`
...
<sub>content-uuid `51da1e9a-3320-8dea-bead-480e7d71dcb2` · framed by typography partition `past` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
