...
> atom `column` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `column`
- partition root `ad6599fa-3200-8c30-89d8-dcc75faaf553`
- bond degree `19`
...
<sub>content-uuid `6cdd8905-5f45-8ef0-a728-fb5cec47a8d5` · framed by typography partition `column` bonds `19` · `pnpm readme` · `pnpm readme:check`</sub>
