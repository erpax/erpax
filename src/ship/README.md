...
> atom `ship` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `ship`
- partition root `8c27033a-adbe-82ad-8486-e958dbce555e`
- bond degree `15`
...
<sub>content-uuid `fcd2b8dc-034b-8bcb-98f5-7aaeaf636d36` · framed by typography partition `ship` bonds `15` · `pnpm readme` · `pnpm readme:check`</sub>
