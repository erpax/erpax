...
> atom `metric` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `metric`
- partition root `add824e7-9af7-8005-bc43-3ca83bed284d`
- bond degree `23`
...
<sub>content-uuid `54414cdf-17dc-8714-81a4-645a812b0752` · framed by typography partition `metric` bonds `23` · `pnpm readme` · `pnpm readme:check`</sub>
