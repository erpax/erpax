...
> atom `where` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `where`
- partition root `ad218905-6d30-81f9-8bce-8fd96ac9579f`
- bond degree `16`
...
<sub>content-uuid `3f64902b-f46c-8b7e-9e91-164552fe00ec` · framed by typography partition `where` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
