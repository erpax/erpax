...
> atom `educational` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition root `3f1ad8af-408c-8de4-95d2-e11afe220e4b`
- bond degree `36`
...
<sub>content-uuid `1a213f00-3684-846c-9d32-205eb0034689` · framed by typography partition `educational` bonds `36` · `pnpm readme` · `pnpm readme:check`</sub>
