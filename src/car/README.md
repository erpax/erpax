...
> atom `car` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `car`
- partition root `7ea60c64-5dcd-831d-9021-cc9338fb6d64`
- bond degree `20`
...
<sub>content-uuid `db93e24d-101e-8f34-97ba-25b8b68c13b9` · framed by typography partition `car` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
