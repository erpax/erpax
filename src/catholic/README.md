...
> atom `catholic` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `catholic`
- partition root `d2eee81d-b2bf-838e-98f7-7bb8f057a3b8`
- bond degree `14`
...
<sub>content-uuid `f1df15f9-1eea-8148-9d7d-811d4b005c84` · framed by typography partition `catholic` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
