...
> atom `enrollment` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition root `43ea80a8-f377-8017-98a9-fc52b9eb623a`
- bond degree `33`
...
<sub>content-uuid `9bcd850d-b175-83db-814e-98684e770730` · framed by typography partition `enrollment` bonds `33` · `pnpm readme` · `pnpm readme:check`</sub>
