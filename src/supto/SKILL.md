...
atomPath: supto
coordinate: "supto · 7/descent · 1fbbf405"
contentUuid: "63d63777-d074-54f6-8abe-8956b72f22ed"
diamondUuid: "1aed5143-01c4-8272-8066-c1d1982e2ce9"
...
bindings: []
signatures:
  computationUuid: "f0b09884-9ab8-8cfc-bedc-1cfedc52c808"
  stages:
    - stage: path
    ...
    - stage: horo
      stageUuid: "5d60b179-e293-85e9-ac50-92a6405c3904"
    - stage: seal
      stageUuid: "5ca8a64b-8f64-89fb-9e6e-82ac282688c6"
    - stage: uuid
      stageUuid: "b6b46902-e650-85c4-8c86-9b1ca8cbad7c"
version: 2
---
...
- **УНП format** — `src/naredba/n/18/unp/index.ts` (format/parse/validate/increment; `parseUnp` = the reverse/decode).
- **Per-ФУ sequence hook** — `src/sale/unp-sequence.ts` (`assignSaleUnpHook`: gapless max+1, frozen on update). The operator code (УНП segment ZZZZ) is derived from the linked `operators` register on create (`operator-code.ts`), not hand-typed.
