...
> atom `lymphatic` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `lymphatic`
- partition root `b36eed61-4e70-89a6-aff4-9d9991587a8b`
- bond degree `16`
...
<sub>content-uuid `255cc060-9cec-8f9b-9571-109c353c2b7c` · framed by typography partition `lymphatic` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
