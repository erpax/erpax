...
/** Credit for claims in src/plugins/taggable/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/plugins/taggable/index.ts — leftover wave proof', () => {
