...
> atom `plugins/mcp/scopes` · horo `—` `—` · [[balance]] `1` · [[seal]] `0`
...
<sub>content-uuid `1cbf1261-27c3-8d8f-8a4f-94b7ad85f194` · framed by typography partition `plugins` bonds `8` · `pnpm readme` · `pnpm readme:check`</sub>
