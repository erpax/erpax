      ...
      ? {
          ...
          components: {
            ...
            beforeNavLinks: [
              ...
              '@/plugins/mcp/components/McpNavLinks#McpNavLinks',
            ],
            ...
            views: {
              ...
              mcpToolBrowser: {
                Component: '@/plugins/mcp/components/ToolBrowser#ToolBrowser',
                path: '/mcp/tools',
              },
              mcpToolInvoker: {
                Component: '@/plugins/mcp/components/ToolInvoker#ToolInvoker',
                path: '/mcp/invoke',
              },
              mcpConsistencyStatus: {
                Component: '@/plugins/mcp/components/ConsistencyStatus#ConsistencyStatus',
                path: '/mcp/status',
              },
              mcpTranslationsEditor: {
                Component: '@/plugins/mcp/components/TranslationsEditor#TranslationsEditor',
