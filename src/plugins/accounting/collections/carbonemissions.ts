...
import { multiTenancyField, statusField, notesField, auditFields, referenceField, legalEntityField, taxonomySelect } from '@/fields/accounting/base-accounting-fields'
import {
  GHG_SCOPE_OPTIONS,
