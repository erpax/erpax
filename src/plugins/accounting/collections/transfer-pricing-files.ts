...
import { multiTenancyField, currencyField, statusField, notesField, auditFields, referenceField, countryCodeField, taxonomySelect } from '@/fields/accounting/base-accounting-fields'
...
const TransferPricingFiles: CollectionConfig = {
  ...
  hooks: {
    ...
    afterChange: [auditTrailAfterChange('transfer-pricing-files')],
  },
  timestamps: true,
}
