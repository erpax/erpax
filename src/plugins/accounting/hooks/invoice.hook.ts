...
export const invoiceAccountingHook: CollectionAfterChangeHook = async ({
  ...
  try {
    ...
    if (glPostingService) {
      ...
      await glPostingService.postInvoice(tenant, invoiceData);
