...
> atom `dataset` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `dataset`
- partition root `9f996d3c-f979-8499-9c9f-54ea7290d872`
- bond degree `16`
...
<sub>content-uuid `037b61ff-a552-8f0d-b39f-2ebda409ebfd` · framed by typography partition `dataset` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
