...
> atom `roles` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
<sub>content-uuid `57530cbc-1dab-83e2-b011-dafa0b94cb4c` · framed by typography partition `roles` bonds `31` · `pnpm readme` · `pnpm readme:check`</sub>
