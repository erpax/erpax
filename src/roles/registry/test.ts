...
/** Credit for claims in src/roles/registry/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/roles/registry/index.ts — leftover wave proof', () => {
