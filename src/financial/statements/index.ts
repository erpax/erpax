...
import { currencyField, notesField } from '@/base/accounting/field'
...
const FinancialStatements: CollectionConfig = {
  ...
  hooks: standardCollectionHooks('financial-statements', { beforeChange: [// SOX §302 disclosure-controls: the user who generated the statement
      // cannot also be the user who certifies/approves it.
      enforceSegregationOfDuties(), // ISO-8601 generation/issuance/approval timestamps.
      autoSetTimestamp('generatedAt', (data) => Boolean(data)), autoSetTimestamp(
        'issuedAt',
