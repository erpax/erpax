...
> atom `cycle` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `cycle`
- partition root `33df03d6-53c1-8e7f-82cc-cdf946f633cd`
- bond degree `29`
...
<sub>content-uuid `8537cdc0-e73d-81c8-b326-7e50c0f84b94` · framed by typography partition `cycle` bonds `29` · `pnpm readme` · `pnpm readme:check`</sub>
