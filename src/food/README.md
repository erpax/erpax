...
> atom `food` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `food`
- partition root `ac78eae9-997d-8af7-92ea-3e431fce67b2`
- bond degree `27`
...
<sub>content-uuid `92f04e87-4a75-846c-84a2-67139f23c579` · framed by typography partition `food` bonds `27` · `pnpm readme` · `pnpm readme:check`</sub>
