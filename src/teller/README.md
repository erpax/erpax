...
> atom `teller` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `teller`
- partition root `59adb2ed-0c12-85c5-a2ee-02c2182e67bf`
- bond degree `24`
...
<sub>content-uuid `2d953836-58c9-83c8-a858-e249b9831b9e` · framed by typography partition `teller` bonds `24` · `pnpm readme` · `pnpm readme:check`</sub>
