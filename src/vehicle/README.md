...
> atom `vehicle` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `vehicle`
- partition root `21563ab1-412d-80d2-9514-9e98c5b16714`
- bond degree `41`
...
<sub>content-uuid `61810291-4aff-8469-bcbe-0db384c346dd` · framed by typography partition `vehicle` bonds `41` · `pnpm readme` · `pnpm readme:check`</sub>
