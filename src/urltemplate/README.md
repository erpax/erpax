...
> atom `urltemplate` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition root `c7fb857f-977a-83fb-bcca-3200cd83936b`
- bond degree `16`
...
<sub>content-uuid `75060bbb-65d7-88df-8f38-0cf581297be5` · framed by typography partition `urltemplate` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
