...
> atom `makes` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `makes`
- partition root `570ab0c9-b7a3-8c2f-9c10-fcd633edf8c8`
- bond degree `32`
...
<sub>content-uuid `9d7416ab-b7ad-879d-92ee-ecef56da47da` · framed by typography partition `makes` bonds `32` · `pnpm readme` · `pnpm readme:check`</sub>
