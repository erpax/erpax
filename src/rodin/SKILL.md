...
atomPath: rodin
coordinate: "rodin · 7/descent · 471dd60d"
contentUuid: "30e5be1f-843c-5fb9-892b-e18ac5860202"
diamondUuid: "22a744c4-e7b6-801a-a125-aab09cadaeef"
...
bindings: []
signatures:
  computationUuid: "5039143b-fb55-8056-93b9-d8a721d1c2c8"
  stages:
    - stage: path
    ...
    - stage: boundary
      stageUuid: "23c990da-be9e-8b4b-97cc-a62a6e7e8903"
    - stage: links
      stageUuid: "934fc64b-312c-80e3-9032-c77135b1b958"
    - stage: horo
      stageUuid: "2cc05c44-989e-8d12-ac11-ddc4365215aa"
    - stage: seal
      stageUuid: "5d638fef-cc7e-86af-acd3-5e023edee363"
    - stage: uuid
      stageUuid: "b7719be4-0a1a-871f-b4d5-48a1b09fb249"
version: 2
---
...
- **`0`** — origin / axis: the anchor itself ([[config]] + [[identity]]); each position carries an *integer multiple* of it, so value comes from the slot, never from outside.
- **`3·6·9`** — the harmonic **triad** [[axis]], three coils 120° out of phase: it **governs**, it does not flow ([[access]] · [[hooks]] · [[auth]]). `3`/`6` are the [[polarity]] boundaries; `9` is the triad's close.
- **`1·2·4·8·7·5`** — the **doubling helix** winding the axis (×2 mod 9): the material/flow cycle (see [[coil]], [[sequence]]).
