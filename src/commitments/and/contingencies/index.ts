...
import { currencyField, statusField, notesField, auditFields, referenceField, legalEntityField } from '@/base/accounting/field'
...
const CommitmentsAndContingencies: CollectionConfig = {
  ...
  hooks: standardCollectionHooks('commitments-and-contingencies'),
  timestamps: true,
}
