...
> atom `secondary` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `secondary`
- partition root `354be15b-da9d-8c75-bc2e-81a06a4ee61f`
- bond degree `10`
...
<sub>content-uuid `b915dcac-9623-8bef-a07f-9f2f834e3e60` · framed by typography partition `secondary` bonds `10` · `pnpm readme` · `pnpm readme:check`</sub>
