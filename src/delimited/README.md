...
> atom `delimited` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `delimited`
- partition root `89429cfd-9626-8aef-ad8b-e40fad3e1c22`
- bond degree `8`
...
<sub>content-uuid `2ce192c8-2661-894d-a669-06612700927e` · framed by typography partition `delimited` bonds `8` · `pnpm readme` · `pnpm readme:check`</sub>
