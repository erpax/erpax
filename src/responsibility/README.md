...
> atom `responsibility` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition root `2e75c16a-17c1-8d68-999f-19d5793e66df`
- bond degree `14`
...
<sub>content-uuid `f974d02e-b43d-83bc-9bff-74320e8b760b` · framed by typography partition `responsibility` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
