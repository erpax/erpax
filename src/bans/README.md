...
> atom `bans` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `bans`
- partition root `2d0d37b8-35ba-8539-8cc4-6fbf0e41afa1`
- bond degree `16`
...
<sub>content-uuid `b63bcefa-e073-87e3-bbcd-1fe7c30312a3` · framed by typography partition `bans` bonds `16` · `pnpm readme` · `pnpm readme:check`</sub>
