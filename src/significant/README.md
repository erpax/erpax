...
> atom `significant` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition root `1a787c15-e60d-86c2-853d-3ff381b0fd3d`
- bond degree `28`
...
<sub>content-uuid `c4723e8b-3d45-8790-8d05-ee637cff9a67` · framed by typography partition `significant` bonds `28` · `pnpm readme` · `pnpm readme:check`</sub>
