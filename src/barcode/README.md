...
> atom `barcode` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
- partition `barcode`
- partition root `efb58195-0ddd-8fcc-a18c-2f7d92ddb663`
- bond degree `9`
...
<sub>content-uuid `7423785d-4395-8039-a9fe-c82dd5dfaadc` · framed by typography partition `barcode` bonds `9` · `pnpm readme` · `pnpm readme:check`</sub>
