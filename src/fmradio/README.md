...
> atom `fmradio` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `fmradio`
- partition root `276b86d2-31e7-8644-a357-4d35ae668b24`
- bond degree `8`
...
<sub>content-uuid `f805816f-c1c7-8a85-aec0-87d584d842fa` · framed by typography partition `fmradio` bonds `8` · `pnpm readme` · `pnpm readme:check`</sub>
