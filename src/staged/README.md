...
> atom `staged` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `staged`
- partition root `b0693c8d-ef5f-874f-b717-fa93de38398e`
- bond degree `8`
...
<sub>content-uuid `2f738053-3987-8b86-a73b-1d28b920a9a9` · framed by typography partition `staged` bonds `8` · `pnpm readme` · `pnpm readme:check`</sub>
