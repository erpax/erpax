...
> atom `evaluated` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `evaluated`
- partition root `604cb925-515e-81c3-8541-a91425076473`
- bond degree `24`
...
<sub>content-uuid `83b5e03c-7742-83b9-86c0-891091769d83` · framed by typography partition `evaluated` bonds `24` · `pnpm readme` · `pnpm readme:check`</sub>
