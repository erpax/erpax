...
signatures:
  ...
  stages:
    ...
    - stage: trinity
      stageUuid: "60d7cd3f-8990-8b4b-9eda-004fd872b16e"
    - stage: boundary
      stageUuid: "ecac46e1-72ac-8b38-8756-c65439990f65"
    - stage: links
...
Extracted from `skill/frontmatter.ts`: a matter file at an atom root is a stray sibling — only `index.ts`, `test.ts` and `seed.ts` live beside a barrel ([[rules]]) — and the lawful form is the child atom it already was, with its own proof beside it.
