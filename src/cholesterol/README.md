...
> atom `cholesterol` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition root `f530b042-8971-8e12-8874-31984ff719dd`
- bond degree `10`
...
<sub>content-uuid `75a848ca-6af1-87f3-b10c-eb4676a74fa7` · framed by typography partition `cholesterol` bonds `10` · `pnpm readme` · `pnpm readme:check`</sub>
