...
> atom `employer` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `employer`
- partition root `65a67077-07c5-84b0-94d7-9f50752139fa`
- bond degree `20`
...
<sub>content-uuid `90e2ca8b-3d85-8e3f-85d4-8b834e04ce70` · framed by typography partition `employer` bonds `20` · `pnpm readme` · `pnpm readme:check`</sub>
