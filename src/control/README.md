...
> atom `control` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `control`
- partition root `d2febfdf-b01f-8579-b9fe-c957ded90b0d`
- bond degree `17`
...
<sub>content-uuid `559bf2ec-523e-8df1-9d85-297321cb669d` · framed by typography partition `control` bonds `17` · `pnpm readme` · `pnpm readme:check`</sub>
