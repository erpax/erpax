...
> atom `protozoa` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `protozoa`
- partition root `e11b6412-de4f-8288-8169-b6f366120360`
- bond degree `14`
...
<sub>content-uuid `3cd64632-06cf-8e5a-b306-f9334710f7ca` · framed by typography partition `protozoa` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
