...
> atom `bar` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition `bar` · sub-root `a40fb56e-2d86-83cb-846e-33609413f096`
...
- partition `bar`
- partition root `a40fb56e-2d86-83cb-846e-33609413f096`
- bond degree `24`
...
<sub>content-uuid `ff9aa3ee-fd98-8495-bfd7-119d788070dc` · framed by typography partition `bar` bonds `24` · `pnpm readme` · `pnpm readme:check`</sub>
