...
> atom `visit` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `visit`
- partition root `36a1c7dc-a2c6-8aa7-bc50-90289b3aeb6a`
- bond degree `13`
...
<sub>content-uuid `7c4964a6-2f90-8ed0-aa94-393a0d049553` · framed by typography partition `visit` bonds `13` · `pnpm readme` · `pnpm readme:check`</sub>
