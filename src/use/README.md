...
> atom `use` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `use`
- partition root `8586a40a-62d1-86e7-8ba8-71bdb84ba054`
- bond degree `25`
...
<sub>content-uuid `38be8472-3bd7-8c8c-ad18-a612584a3a09` · framed by typography partition `use` bonds `25` · `pnpm readme` · `pnpm readme:check`</sub>
