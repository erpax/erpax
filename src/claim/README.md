...
> atom `claim` · horo `4` `weave` · [[balance]] `0` · [[seal]] `0`
...
- partition `claim`
- partition root `8899a65f-662d-8349-8cb5-995f89cfd557`
- bond degree `19`
...
<sub>content-uuid `537c3573-9d49-8018-bfc8-6452d533d1ac` · framed by typography partition `claim` bonds `19` · `pnpm readme` · `pnpm readme:check`</sub>
