...
> atom `defoundation` · horo `8` `crest` · [[balance]] `0` · [[seal]] `0`
...
- partition root `b1302788-b849-89bb-b613-51835ce5317b`
- bond degree `14`
...
<sub>content-uuid `dda76128-5515-87f1-9033-3410ad911cc4` · framed by typography partition `defoundation` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
