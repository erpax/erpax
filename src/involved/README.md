...
> atom `involved` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `involved`
- partition root `73384ac7-18f4-827c-94a6-31de8a372c8f`
- bond degree `14`
...
<sub>content-uuid `5653f785-b067-82ce-b8b1-a7f603f548f5` · framed by typography partition `involved` bonds `14` · `pnpm readme` · `pnpm readme:check`</sub>
