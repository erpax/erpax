...
> atom `spread` · horo `2` `share` · [[balance]] `0` · [[seal]] `0`
...
- partition `spread`
- partition root `e2b16414-1854-8706-9529-5c8df7c6ba6b`
- bond degree `24`
...
<sub>content-uuid `0128bbc4-823b-80d3-aa53-a155f85ab086` · framed by typography partition `spread` bonds `24` · `pnpm readme` · `pnpm readme:check`</sub>
