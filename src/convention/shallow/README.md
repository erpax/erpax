...
> atom `convention/shallow` · horo `1` `base` · [[balance]] `0` · [[seal]] `0`
...
<sub>content-uuid `06e75278-4c4f-8769-a8af-c41e3aa93de6` · framed by typography partition `convention` bonds `22` · `pnpm readme` · `pnpm readme:check`</sub>
