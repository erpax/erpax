...
> atom `reported` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `reported`
- partition root `102f2da5-22d5-8700-ac67-332345b648f4`
- bond degree `19`
...
<sub>content-uuid `54899a2c-fe53-83af-91e0-dbd908f14c5b` · framed by typography partition `reported` bonds `19` · `pnpm readme` · `pnpm readme:check`</sub>
