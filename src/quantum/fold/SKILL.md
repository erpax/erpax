...
signatures:
  ...
  stages:
    ...
    - stage: horo
      stageUuid: "a998e693-c4ef-842e-bbf8-0af114754be4"
    - stage: seal
...
quantum:
  superposition:
    ...
    - superposition
  collapse:
    - "Use when reasoning about fold — Double fold is mandatory for quantum mentality: word ⊗ digit; 2D documents present both sheets until seal."
    - "double fold is mandatory for quantum mentality: word ⊗ digit; 2D documents present both sheets until seal."
  seal:
    sandbox: false
    receipt: false
    pathFollow: true
...
**Law — [[law]]: double fold is mandatory for quantum mentality: word ⊗ digit; 2D documents present both sheets until seal.**
