...
> atom `quantum/particle` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
<sub>content-uuid `2d2ddcd3-4cc4-8f2f-9756-2e87fde05ae7` · framed by typography partition `quantum` bonds `26` · `pnpm readme` · `pnpm readme:check`</sub>
