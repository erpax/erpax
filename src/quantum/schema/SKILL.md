...
coordinate: "quantum/schema · 5/round · ae31f695"
contentUuid: "0e699365-5b9d-5aaa-8998-a2af5cbca0b8"
diamondUuid: "7dec55f4-0161-8de5-83ea-7de4d209c36d"
uuid: "ae31f695-475f-8ca0-adfd-f659f10e728f"
horo: 5
typography:
  partition: quantum
  bondDegree: 57
...
bindings: []
signatures:
  computationUuid: "c397181b-11f6-8e47-aaec-2e9bbc3b5abb"
  stages:
    - stage: path
    ...
    - stage: horo
      stageUuid: "25fbfd22-02e4-864b-a6b4-77ae5602533f"
    - stage: seal
      stageUuid: "dbe0e97e-797c-8188-8642-d83860061016"
    - stage: uuid
      stageUuid: "7398ff97-f599-80db-bf26-10f3bb8bdf0d"
quantum:
  superposition:
    - cardinality
    - collections
...
<sub>content-uuid `0e699365-5b9d-5aaa-8998-a2af5cbca0b8` · account `quantum/schema` · `pnpm skill:upgrade` · `pnpm computed:check`</sub>
