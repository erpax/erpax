...
Because every word resolves to the shared set, the corpus speaks one language with zero meaning-entropy — the same law as the [[law]] (coverage = 1 ⇒ unbounded tamper cost), read on the meaning axis. Merges into [[vocabulary]].
