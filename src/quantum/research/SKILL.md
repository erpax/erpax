...
coordinate: "quantum/research · 7/descent · 2fb2a170"
contentUuid: "18817fb3-789f-5e9a-a0a7-07f5bc629e2e"
diamondUuid: "d3ca247e-96d4-838c-b46a-2f481aa9b6de"
uuid: "2fb2a170-022d-834a-97ba-bf204e2631d7"
horo: 7
typography:
  partition: quantum
  bondDegree: 158
...
bindings: []
signatures:
  computationUuid: "d3df11a4-7123-826c-be3c-919ff427e6a3"
  stages:
    - stage: path
      stageUuid: "ba55283e-0402-8b68-a921-9daf2fbc6ba6"
    - stage: trinity
      stageUuid: "f5455d95-2f0e-8995-862c-07a0119b3425"
    - stage: boundary
      stageUuid: "f9e5c62c-6e07-8217-9188-9f349edbb49a"
    - stage: links
      stageUuid: "32e858a2-cc08-8b39-bddf-97f63ac2ad67"
    - stage: horo
      stageUuid: "8120974b-f861-8037-b6e5-14a7a5666c36"
    - stage: seal
      stageUuid: "ad4211d7-8199-8e85-b2bb-74fad42f7c01"
    - stage: uuid
      stageUuid: "ecc34e2b-360a-81cf-adfd-c8e981a72ab6"
quantum:
  superposition:
    - accounting
    - akashic
    ...
    - superposition
  collapse:
    - "Use when pricing research on the quantum scale — a research run consumes resources (agents × tokens) and produces value (entropy reduced), so it is a billable expense whose worth is the disorder it closes; worthwhile only when it reduces more entropy than it costs."
    - "cost = agents × tokens (the run's real spend); value = entropy reduced; the ledger balances, never asserted"
    - "double-entry (the research run as a balanced expense ⊕ value posting)"
    - "matter-twin:src/quantum/research/index.ts"
    - "research is a billable expense, and its worth is the entropy it reduces. A run debits the resources it consumes (agents × tokens) and credits the disorder it closes; it is worthwhile only when it reduces more entropy than it costs."
  seal:
    sandbox: false
    receipt: false
    pathFollow: true
...
<sub>content-uuid `18817fb3-789f-5e9a-a0a7-07f5bc629e2e` · account `quantum/research` · `pnpm skill:upgrade` · `pnpm computed:check`</sub>
