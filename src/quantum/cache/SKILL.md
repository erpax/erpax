...
coordinate: "quantum/cache · 2/share · b7ff9422"
contentUuid: "303852dd-d5a4-5e15-bf65-850bc9e76f51"
diamondUuid: "afb4c786-057c-8415-8905-3a40be6833d9"
uuid: "b7ff9422-7fd8-8339-bd1d-6bbb52f8c8e8"
horo: 2
typography:
  partition: quantum
  bondDegree: 51
...
bindings: []
signatures:
  computationUuid: "0f133b34-ab92-808f-9bcb-780f80d40a6d"
  stages:
    - stage: path
    ...
    - stage: horo
      stageUuid: "edc3060c-f26c-8479-9b83-b3fbc064a6e1"
    - stage: seal
      stageUuid: "abccbfd8-710b-8146-8454-7275d7eb382c"
    - stage: uuid
      stageUuid: "e382223a-4a9f-8fda-b22b-89b1499e5192"
quantum:
  superposition:
    - artery
    - bindings
...
<sub>content-uuid `303852dd-d5a4-5e15-bf65-850bc9e76f51` · account `quantum/cache` · `pnpm skill:upgrade` · `pnpm computed:check`</sub>
