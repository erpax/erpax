...
/** Credit for claims in src/email/resend/adapter/index.ts — chatHealLeftoverWave; not an empty gaming test. */
describe('src/email/resend/adapter/index.ts — leftover wave proof', () => {
