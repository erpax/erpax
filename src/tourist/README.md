...
> atom `tourist` · horo `7` `descent` · [[balance]] `0` · [[seal]] `0`
...
- partition `tourist`
- partition root `5b81fa0b-36de-827d-887e-d7f027d7c8f5`
- bond degree `33`
...
<sub>content-uuid `ae12abdc-a291-839f-aa50-f326aab77ca0` · framed by typography partition `tourist` bonds `33` · `pnpm readme` · `pnpm readme:check`</sub>
