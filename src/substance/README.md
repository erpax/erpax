...
> atom `substance` · horo `5` `round` · [[balance]] `0` · [[seal]] `0`
...
- partition `substance`
- partition root `9460a006-aad7-8772-a07c-4a0bb57d77c3`
- bond degree `17`
...
<sub>content-uuid `ca23c634-2438-8cba-889f-c043b24487bc` · framed by typography partition `substance` bonds `17` · `pnpm readme` · `pnpm readme:check`</sub>
