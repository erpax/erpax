/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 801d81f80817fc13e06d6837a12293f1)
// Runtime types generated with workerd@1.20260507.1 2025-08-15 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "TenantQuotaCounter" | "RateLimiter" | "JobLock" | "AuditChain" | "ErpaxStateDO";
	}
	interface Env {
		...
		ANALYTICS_GL: AnalyticsEngineDataset;
		ANALYTICS_API: AnalyticsEngineDataset;
		ANALYTICS_JOBS: AnalyticsEngineDataset;
		QUEUE_AI_BATCH: Queue;
		QUEUE_EINVOICE_OUT: Queue;
		QUEUE_DUNNING_OUT: Queue;
		QUEUE_PERIOD_CLOSE: Queue;
		QUEUE_EMAIL_OUT: Queue;
		BROWSER: Fetcher;
		AI: Ai;
		...
		ERPAX_DO: DurableObjectNamespace<import("./worker").ErpaxStateDO>;
		TENANT_QUOTA: DurableObjectNamespace<import("./worker").TenantQuotaCounter>;
		RATE_LIMITER: DurableObjectNamespace<import("./worker").RateLimiter>;
		JOB_LOCK: DurableObjectNamespace<import("./worker").JobLock>;
		AUDIT_CHAIN_DO: DurableObjectNamespace<import("./worker").AuditChain>;
		WORKER_SELF_REFERENCE: Service<typeof import("./worker").default>;
		RATE_LIMITER_API: RateLimit;
		RATE_LIMITER_AI: RateLimit;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "PAYLOAD_MCP_API_KEY">> {}
}
