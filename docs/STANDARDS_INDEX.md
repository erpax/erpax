...
src/standards/emit.ts:375: * @standard ISO/IEC-25010:2023 §5.4 reusability (one scan, two consumers)
src/standards/emit.ts:376: * @standard ISO-19011:2018 §6.4 audit-evidence (the citation index)
src/standards/emit.ts:541: * @standard ISO 3166-1 alpha-2 — the territory codes this returns for a country
...
src/standards/emit.ts:377: * @rfc 9562 content-uuid (each standard row is content-addressed)
