...
**3478** atoms · **38797** bonds · corpus `3b404aa5-4e44-852a-bfe1-acea5c1b852a` · README `2e808c37-1ac8-85e5-aa31-a30501b41e3d` · sealed **3088**/**3478** · **11** [[cloudflare]] · **2717** [[standards]]

## [[pivot]]

7 horo · form **3477** · code **1420** · proof **1441**

### the horo ring — the diamond's facets

Measure-walk `1·2·4·8·7·5·9` · **7** facets · **3456** ring atoms — principal facets ranked by bond in-degree.

| digit | measure | atoms | principal facets |
| ----: | ------- | ----: | ---------------- |
| 1 | base | 578 | `law` · `action` · `entropy` · `type` · `angel` · `service` |
| 2 | share | 584 | `merge` · `sti` · `rules` · `horo` · `tamper` · `rodin` |
| 4 | weave | 577 | `uuid` · `quantum` · `standard` · `society` · `diamond` · `duality` |
| 8 | crest | 552 | `thing` · `balance` · `gate` · `trinity` · `skills` · `time` |
| 7 | descent | 581 | `collapse` · `accounting` · `proof` · `fractal` · `atom` · `matrix` |
| 5 | round | 571 | `sequence` · `medical` · `aura` · `field` · `transaction` · `breath` |
...
Cross-tab of **3478** folder README models — state × count per axis.
...
- gap `709.045` eb · seal `40046.38` eb · net `-39337.335` eb · ratio `56.479`
- sealed `3088` · unsealed `390`
...
`1.0.3` · `CC-BY-NC-ND-4.0`

Every path — ([CC-BY-NC-ND-4.0](LICENSE) / commercial) via `license@erpax.com`.

---

<sub>generated by `pnpm readme` · verified by `pnpm readme:check` · this README is a diamond — content-uuid `2e808c37-1ac8-85e5-aa31-a30501b41e3d`, regenerated from the live tree; any drift fails the gate.</sub>

<sub>erpax:src · content-uuid 2e808c37-1ac8-85e5-aa31-a30501b41e3d · © erpax · CC-BY-NC-ND-4.0 · source https://github.com/erpax/erpax · doi 10.5281/zenodo.22237698 · commercial license@erpax.com</sub>
