...
- corpus address `19b1e04e-a3e5-837f-9023-ca4e54c3995d`
- **2877** atoms · **36406** bonds (the K₁₃ lattice)
- this README `3003722e-0370-840e-8f70-accdb60ceed5` — itself a diamond, regenerable from the tree
...
| ----: | ------- | ----: | ---------------- |
| 1 | base | 447 | `uuid` · `standard` · `society` · `action` · `fractal` · `self` |
| 2 | share | 478 | `merge` · `proof` · `cost` · `horo` · `duality` · `diamond` |
| 4 | weave | 488 | `collapse` · `sti` · `thing` · `fields` · `aura` · `breath` |
| 8 | crest | 491 | `law` · `balance` · `agent` · `science` · `torus` · `chat` |
| 7 | descent | 495 | `entropy` · `type` · `akashic` · `matrix` · `gravity` · `health` |
| 5 | round | 469 | `accounting` · `sequence` · `quantum` · `atom` · `agriculture` · `rodin` |
...
- **2877** atoms — one-word folders, each a sealed vertex
- **3057** `SKILL.md` — the form (antimatter)
- **834** `index.ts` — the code (matter)
- **634** `test.ts` — the proof
...
- **2633** / **3058** sealed · **3058** / **3058** balanced
- mean bond degree `51.26` · total variance `0`
- **15** atoms with [[cloudflare]] bindings · **2058** distinct [[standards]] cited
...
- `pnpm skill:upgrade` — `tsx src/skill/router/upgrade/index.ts --sync`
- `pnpm skill:upgrade:check` — `tsx src/skill/router/upgrade/index.ts --verify`
...
<sub>generated by `pnpm readme` · verified by `pnpm readme:check` · this README is a diamond — content-uuid `3003722e-0370-840e-8f70-accdb60ceed5`, regenerated from the live tree; any drift fails the gate.</sub>
