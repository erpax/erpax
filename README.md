...
**3409** atoms · **38340** bonds · corpus `59ccc8c7-77c7-8c45-86f3-84d95d3240f8` · README `2d7d37cb-568c-8404-b2f6-6da97a6c54e6` · sealed **2967**/**3409** · **11** [[cloudflare]] · **2706** [[standards]]

## [[pivot]]

7 horo · form **3408** · code **1387** · proof **1407**

### the horo ring — the diamond's facets

Measure-walk `1·2·4·8·7·5·9` · **7** facets · **3388** ring atoms — principal facets ranked by bond in-degree.

| digit | measure | atoms | principal facets |
| ----: | ------- | ----: | ---------------- |
| 1 | base | 572 | `law` · `merge` · `uuid` · `quantum` · `action` · `entropy` |
| 2 | share | 566 | `sti` · `horo` · `tamper` · `rodin` · `archangel` · `rate` |
| 4 | weave | 558 | `standard` · `society` · `diamond` · `duality` · `self` · `cost` |
| 8 | crest | 550 | `thing` · `balance` · `proof` · `gate` · `trinity` · `agent` |
| 7 | descent | 562 | `collapse` · `accounting` · `fractal` · `atom` · `matrix` · `holographic` |
| 5 | round | 567 | `rules` · `sequence` · `medical` · `aura` · `field` · `transaction` |
...
Cross-tab of **3409** folder README models — state × count per axis.
...
- gap `2440.435` eb · seal `38942.895` eb · net `-36502.46` eb · ratio `15.957`
- sealed `2967` · unsealed `442`
...
`1.0.2` · `CC-BY-NC-ND-4.0`

Every path — ([CC-BY-NC-ND-4.0](LICENSE) / commercial) via `license@erpax.com`.

---

<sub>generated by `pnpm readme` · verified by `pnpm readme:check` · this README is a diamond — content-uuid `2d7d37cb-568c-8404-b2f6-6da97a6c54e6`, regenerated from the live tree; any drift fails the gate.</sub>
