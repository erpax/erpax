...
- this README `0826f4e9-b980-8677-8d43-c04fd2f319e9` — itself a diamond, regenerable from the tree
...
- **831** `index.ts` — the code (matter)
- **629** `test.ts` — the proof
...
- **3035** / **3055** sealed · **3055** / **3055** balanced
- mean bond degree `51.23` · total variance `0`
...
<sub>generated by `pnpm readme` · verified by `pnpm readme:check` · this README is a diamond — content-uuid `0826f4e9-b980-8677-8d43-c04fd2f319e9`, regenerated from the live tree; any drift fails the gate.</sub>
