...
- corpus address `3cca5c94-18f1-830b-8744-cad51e0cafce`
- **2787** atoms · **33011** bonds (the K₁₃ lattice)
- this README `b489ee8c-a0e0-8dfd-94a6-64072ac7fd4b` — itself a diamond, regenerable from the tree
...
| ----: | ------- | ----: | ---------------- |
| 1 | base | 441 | `landmarks` · `action` · `seed` · `symbol` · `3986` · `gears` |
| 2 | share | 471 | `memories` · `accounting` · `akashic` · `mention` · `breakfast` · `catalogue` |
| 4 | weave | 464 | `cohort` · `progression` · `corrects` · `dropoff` · `marine` · `holographic` |
| 8 | crest | 474 | `balance` · `spouse` · `sell` · `tour` · `qualification` · `notice` |
| 7 | descent | 480 | `id` · `terminals` · `list` · `fertility` · `sanitization` · `sections` |
| 5 | round | 449 | `stat` · `homeopathic` · `agriculture` · `entity` · `wp` · `euenergy` |
| 9 | unity | 5 | `config` · `whole` · `identity` · `signal` · `zeropoint` |

> The control axis governs off the flow ring — `3` access · `6` hooks (3: 0 atoms · 6: 3 atoms), `9` unity closes and `0` is the zeropoint root.

## the trinity — every atom told three ways

- **2787** atoms — one-word folders, each a sealed vertex
- **3045** `SKILL.md` — the form (antimatter)
- **818** `index.ts` — the code (matter)
- **613** `test.ts` — the proof
...
<sub>generated by `pnpm readme` · verified by `pnpm readme:check` · this README is a diamond — content-uuid `b489ee8c-a0e0-8dfd-94a6-64072ac7fd4b`, regenerated from the live tree; any drift fails the gate.</sub>
