...
- this README `7ec8374c-c9c2-8257-8f37-26a2486cf804` — itself a diamond, regenerable from the tree
...
- **3043** `SKILL.md` — the form (antimatter)
- **816** `index.ts` — the code (matter)
- **611** `test.ts` — the proof
...
<sub>generated by `pnpm readme` · verified by `pnpm readme:check` · this README is a diamond — content-uuid `7ec8374c-c9c2-8257-8f37-26a2486cf804`, regenerated from the live tree; any drift fails the gate.</sub>
